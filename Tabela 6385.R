...
calcula_ocup_desocup <- function(mesano){
  pnadc <- pnadc_design(read_pnadc(paste0("C:/Users/italo/Desktop/trimestral/txt/PNADC_0",mesano,".txt"), 
    ...
    update(
           ...
           ocupada1 = 1 * (VD4002 == 1 & (V4040 == 1 | V4040 == 2)),
           ocupada3 = 1 * (VD4002 == 1 & V4040 == 3),
           ocupada4 = 1 * (VD4002 == 1 & V4040 == 4),
           
           one = 1 * (ocupada1==1 | ocupada3==1 | ocupada4==1),
  ...
  rm(estimativas_t, estimativas_1, estimativas_3, estimativas_4, pnadc)
  gc()
...
mg<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                     ...
                                     13,26,39,52)], function(df) {
                                       data.frame(
                                         ...
                                         "Total - Menos de 1 ano" = as.numeric(df[11,4]),
...
bh<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                     ...
                                     13,26,39,52)], function(df) {
                                       data.frame(
                                         ...
                                         "Total - Menos de 1 ano" = as.numeric(df[1,4]),
...
entornobhcolar<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                            ...
                                            13,26,39,52)], function(df) {
                                              data.frame(
                                                ...
                                                "Total - Menos de 1 ano" = as.numeric(df[2,4]),
...
sulmg<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                        ...
                                        13,26,39,52)], function(df) {
                                          data.frame(
                                            ...
                                            "Total - Menos de 1 ano" = as.numeric(df[3,4]),
...
trng<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                       ...
                                       13,26,39,52)], function(df) {
                                         data.frame(
                                           ...
                                           "Total - Menos de 1 ano" = as.numeric(df[4,4]),
...
zonamata<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                           ...
                                           13,26,39,52)], function(df) {
                                             data.frame(
                                               ...
                                               "Total - Menos de 1 ano" = as.numeric(df[5,4]),
...
nortemgride<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                          ...
                                          13,26,39,52)], function(df) {
                                            data.frame(
                                              ...
                                              "Total - Menos de 1 ano" = as.numeric(df[6,4]),
...
riodoce<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                          ...
                                          13,26,39,52)], function(df) {
                                            data.frame(
                                              ...
                                              "Total - Menos de 1 ano" = as.numeric(df[7,4]),
...
central<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                          ...
                                          13,26,39,52)], function(df) {
                                            data.frame(
                                              ...
                                              "Total - Menos de 1 ano" = as.numeric(df[8,4]),
...
baseestratatualV6385<-list("01-Belo Horizonte"=bh,"02-Entorno metropolitano + Colar de BH"=entornobhcolar,
