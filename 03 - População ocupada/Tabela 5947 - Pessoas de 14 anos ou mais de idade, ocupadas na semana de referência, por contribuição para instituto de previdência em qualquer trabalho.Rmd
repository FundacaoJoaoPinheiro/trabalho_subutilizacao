...
Pessoas de 14 anos ou mais de idade, ocupadas na semana de referência, por contribuição para instituto de previdência em qualquer trabalho - Contribuinte


```{r}
total_01 <- svyby(~ocupados, by = ~estratos_geogr, subset(dadosPNADc, VD4012=="Contribuinte"), svytotal, na.rm=TRUE)

total_01cv <- round(cv(svyby(~ocupados, by = ~estratos_geogr, subset(dadosPNADc, VD4012=="Contribuinte"), svytotal, na.rm=TRUE))*100,1)

knitr::kable(total_01,
             caption = "Pessoas de 14 anos ou mais de idade, ocupadas na semana de referência, por contribuição para instituto de previdência em qualquer trabalho - Contribuinte")

total_01cv
```

Pessoas de 14 anos ou mais de idade, ocupadas na semana de referência, por contribuição para instituto de previdência em qualquer trabalho - Não Contribuinte


```{r}
total_02 <- svyby(~ocupados, by = ~estratos_geogr, subset(dadosPNADc, VD4012=="Não contribuinte"), svytotal, na.rm=TRUE)

total_02cv <- round(cv(svyby(~ocupados, by = ~estratos_geogr, subset(dadosPNADc, VD4012=="Não contribuinte"), svytotal, na.rm=TRUE))*100,1)

knitr::kable(total_02,
             caption = "Pessoas de 14 anos ou mais de idade, ocupadas na semana de referência, por contribuição para instituto de previdência em qualquer trabalho - Não Contribuinte")
