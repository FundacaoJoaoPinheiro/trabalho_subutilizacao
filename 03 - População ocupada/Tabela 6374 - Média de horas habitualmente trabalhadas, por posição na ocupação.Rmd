...
```{r}
mediahoras <- coef(svyby(~VD4031,by = ~estratos_geogr+VD4007, subset(dadosPNADc,UF=="Minas Gerais"), svymean,na.rm = TRUE))

mediahorascv <- round(cv(svyby(~VD4031,by = ~estratos_geogr+VD4007, subset(dadosPNADc,UF=="Minas Gerais"), svymean,na.rm = TRUE))*100,1)

knitr::kable(mediahoras,
             caption = "Média de horas habitualmente trabalhadas por semana e efetivamente trabalhadas na semana de referência, no trabalho principal, das pessoas de 14 anos ou mais de idade, por posição na ocupação")

knitr::kable(mediahorascv,
             caption = "Coeficiente de variação - Média de horas habitualmente trabalhadas por semana e efetivamente trabalhadas na semana de referência, no trabalho principal, das pessoas de 14 anos ou mais de idade, por posição na ocupação")
```
