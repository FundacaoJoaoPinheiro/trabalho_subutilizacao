...
```
Tabela 5438 - Rendimento médio mensal real das pessoas de 14 anos ou mais de idade ocupadas na semana de referência com rendimento de trabalho, habitualmente e efetivamente recebidos no trabalho principal e em todos os trabalhos, por nível de instrução


```{r dados, echo=TRUE, warning=FALSE}

media_massa_nominal_instr <- svyby(~rend, by = ~estratos_geogr+nivel1, subset(dadosPNADc, VD4002=="Pessoas ocupadas"), svymean, na.rm=TRUE)

media_massa_nominal_instrcv <- round(cv(svyby(~rend, by = ~estratos_geogr+nivel1, subset(dadosPNADc, VD4002=="Pessoas ocupadas"), svymean, na.rm=TRUE))*100,1)

knitr::kable(media_massa_nominal_instr,
             caption = "Massa de rendimento mensal nominal média efetivamente recebida - nível de instrução, por estratos geográficos - Minas Gerais - 2022 - Trabalho principal")

knitr::kable(media_massa_nominal_instrcv,
             caption = "Coeficiente de variação - Massa de rendimento mensal nominal média efetivamente recebida - nível de instrução, por estratos geográficos - Minas Gerais - 2022 - Trabalho principal")
