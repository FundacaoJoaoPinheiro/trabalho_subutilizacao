...
knitr::kable(media_massa_nominal_instr,
             caption = "Massa de rendimento mensal nominal média efetivamente recebida - nível de instrução, por estratos geográficos - Minas Gerais - 2022 - Todos os trabalhos")

knitr::kable(media_massa_nominal_instrcv,
             caption = "Coeficiente de variação - Massa de rendimento mensal nominal média efetivamente recebida - nível de instrução, por estratos geográficos - Minas Gerais - 2022 - Todos os trabalhos")
