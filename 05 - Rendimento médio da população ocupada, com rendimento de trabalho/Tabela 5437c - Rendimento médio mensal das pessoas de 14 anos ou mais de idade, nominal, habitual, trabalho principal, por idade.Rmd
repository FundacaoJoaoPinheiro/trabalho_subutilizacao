...
Tabela 5437 - Rendimento médio mensal real das pessoas de 14 anos ou mais de idade ocupadas na semana de referência com rendimento de trabalho, habitualmente recebidos no trabalho principal e em todos os trabalhos, por grupo de idade

#Calcular o rendimento médio mensal nominal habitual, no trabalho principal, por grupo de idade, nos estratos geográficos
...
knitr::kable(media_massa_nominal_idade,
             caption = "Massa de rendimento mensal nominal média habitualmente recebida - por faixa de idade, por estratos geográficos - Minas Gerais - 2022 - Trabalho principal")

knitr::kable(media_massa_nominal_idadecv,
             caption = "Coeficiente de variação - Massa de rendimento mensal nominal média habitualmente recebida - por faixa de idade, por estratos geográficos - Minas Gerais - 2022 - Trabalho principal")
