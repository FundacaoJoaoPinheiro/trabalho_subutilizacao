...
calcula_ocup_desocup <- function(ano){
  pnadc <- pnadc_design(read_pnadc(paste0("C:/Users/italo/Desktop/MICRODADOS/txt/PNADC_",ano,".txt"), 
                                   paste0("C:/Users/italo/Desktop/MICRODADOS/doc/input_PNADC_",ano,".txt"),vars=c("VD4002","V2007", "V2009", "V2010", "VD4019", "VD4015", "VD4007"))) %>% 
    update(
...
saveRDS(baseestratatualmassapos,file = "C:/Users/italo/Desktop/MICRODADOS/baseestratatualmassapos.rds")
