...
#Tabela 6405 - Rendimento médio mensal real das pessoas de 14 anos ou mais de idade ocupadas na semana de referência com rendimento de trabalho, habitualmente e efetivamente recebidos no trabalho principal e em todos os trabalhos, por instrução
...
calcula_ocup_desocup <- function(ano){
  pnadc <- pnadc_design(read_pnadc(paste0("C:/Users/italo/Desktop/MICRODADOS/txt/PNADC_",ano,".txt"), 
    ...
    update(
           ...
           renda_trabalho_princ_1 = ifelse(ocupados %in% 1 & raca1 == 1, VD4016, NA),
           renda_trabalho_princ_2 = ifelse(ocupados %in% 1 & raca2 == 2, VD4016, NA),
           renda_trabalho_princ_3 = ifelse(ocupados %in% 1 & raca3 == 3, VD4016, NA),
           renda_trabalho_princ_4 = ifelse(ocupados %in% 1 & raca4 == 4, VD4016, NA),
           renda_tt_1 = ifelse(ocupados %in% 1 & raca1 == 1, VD4019, NA),
           renda_tt_2 = ifelse(ocupados %in% 1 & raca2 == 2, VD4019, NA),
           renda_tt_3 = ifelse(ocupados %in% 1 & raca3 == 3, VD4019, NA),
           renda_tt_4 = ifelse(ocupados %in% 1 & raca4 == 4, VD4019, NA),
