...
calcula_ocup_desocup <- function(ano){
  pnadc <- pnadc_design(read_pnadc(paste0("C:/Users/italo/Desktop/MICRODADOS/txt/PNADC_",ano,".txt"), 
                                   paste0("C:/Users/italo/Desktop/MICRODADOS/doc/input_PNADC_",ano,".txt"),vars=c("VD4002","V2007", "V2009", "V2010", "VD4019", "VD4015", "VD4007", "VD4016", "VD3004", "VD4009", "VD4010"))) %>% 
    update(
           ...
           renda_trabalho_princ_1 = ifelse(ocupados %in% 1 & VD4010 == 1, VD4016, NA),
           renda_trabalho_princ_2 = ifelse(ocupados %in% 1 & VD4010 == 2, VD4016, NA),
           renda_trabalho_princ_3 = ifelse(ocupados %in% 1 & VD4010 == 3, VD4016, NA),
           renda_trabalho_princ_4 = ifelse(ocupados %in% 1 & VD4010 == 4, VD4016, NA),
           renda_trabalho_princ_5 = ifelse(ocupados %in% 1 & VD4010 == 5, VD4016, NA),
           renda_trabalho_princ_6 = ifelse(ocupados %in% 1 & VD4010 == 6, VD4016, NA),
           renda_trabalho_princ_7 = ifelse(ocupados %in% 1 & VD4010 == 7, VD4016, NA),
           renda_trabalho_princ_8 = ifelse(ocupados %in% 1 & VD4010 == 8, VD4016, NA),
           renda_trabalho_princ_9 = ifelse(ocupados %in% 1 & VD4010 == 9, VD4016, NA),
           renda_trabalho_princ_10 = ifelse(ocupados %in% 1 & VD4010 == 10, VD4016, NA),
           renda_trabalho_princ_11 = ifelse(ocupados %in% 1 & VD4010 == 11, VD4016, NA),
           renda_trabalho_princ_12 = ifelse(ocupados %in% 1 & VD4010 == 12, VD4016, NA),
  ...
  estimativas_1 <- svyby(~renda_trabalho_princ_1, by = ~regioes, subset(pnadc, UF =="31" & ~VD4010=="1"), vartype="cv", na.rm = TRUE, svymean)
  colnames(estimativas_1)[3]<-"cv_1"
  
  estimativas_2 <- svyby(~renda_trabalho_princ_2, by = ~regioes, subset(pnadc, UF =="31" & ~VD4010=="2"), vartype="cv", na.rm = TRUE, svymean)
  colnames(estimativas_2)[3]<-"cv_2"
  
  estimativas_3 <- svyby(~renda_trabalho_princ_3, by = ~regioes, subset(pnadc, UF =="31" & ~VD4010=="3"), vartype="cv", na.rm = TRUE, svymean)
  colnames(estimativas_3)[3]<-"cv_3"
  
  estimativas_4 <- svyby(~renda_trabalho_princ_4, by = ~regioes, subset(pnadc, UF =="31" & ~VD4010=="4"), vartype="cv", na.rm = TRUE, svymean)
  colnames(estimativas_4)[3]<-"cv_4"
  
  estimativas_5 <- svyby(~renda_trabalho_princ_5, by = ~regioes, subset(pnadc, UF =="31" & ~VD4010=="5"), vartype="cv", na.rm = TRUE, svymean)
  colnames(estimativas_5)[3]<-"cv_5"
  
  estimativas_6 <- svyby(~renda_trabalho_princ_6, by = ~regioes, subset(pnadc, UF =="31" & ~VD4010=="6"), vartype="cv", na.rm = TRUE, svymean)
  colnames(estimativas_6)[3]<-"cv_6"
  
  estimativas_7 <- svyby(~renda_trabalho_princ_7, by = ~regioes, subset(pnadc, UF =="31" & ~VD4010=="7"), vartype="cv", na.rm = TRUE, svymean)
  colnames(estimativas_7)[3]<-"cv_7"
  
  estimativas_8 <- svyby(~renda_trabalho_princ_8, by = ~regioes, subset(pnadc, UF =="31" & ~VD4010=="8"), vartype="cv", na.rm = TRUE, svymean)
  colnames(estimativas_8)[3]<-"cv_8"
  
  estimativas_9 <- svyby(~renda_trabalho_princ_9, by = ~regioes, subset(pnadc, UF =="31"  & ~VD4010=="9"), vartype="cv", na.rm = TRUE, svymean)
  colnames(estimativas_9)[3]<-"cv_9"
  
  estimativas_10 <- svyby(~renda_trabalho_princ_10, by = ~regioes, subset(pnadc, UF =="31" & VD4010=="10"), vartype="cv", na.rm = TRUE, svymean)
  colnames(estimativas_10)[3]<-"cv_10"
  
  estimativas_11 <- svyby(~renda_trabalho_princ_11, by = ~regioes, subset(pnadc, UF =="31" & VD4010=="11"), vartype="cv", na.rm = TRUE, svymean)
  colnames(estimativas_11)[3]<-"cv_11"
  
  estimativas_12 <- svyby(~renda_trabalho_princ_12, by = ~regioes, subset(pnadc, UF =="31" & VD4010=="12"), vartype="cv", na.rm = TRUE, svymean)
  ...
  total_ocupada8<- svymean(~renda_trabalho_princ_8, subset(pnadc, UF=="31"),na.rm = TRUE)
  total_ocupada9<- svymean(~renda_trabalho_princ_9, subset(pnadc, UF=="31"),na.rm = TRUE)
  total_ocupada10<- svymean(~renda_trabalho_princ_10, subset(pnadc, UF=="31"),na.rm = TRUE)
  total_ocupada11<- svymean(~renda_trabalho_princ_11, subset(pnadc, UF=="31"),na.rm = TRUE)
  total_ocupada12<- svymean(~renda_trabalho_princ_12, subset(pnadc, UF=="31"),na.rm = TRUE)
  ...
  rm(estimativas_1, estimativas_2, estimativas_3, estimativas_4, estimativas_5, estimativas_6, estimativas_7, estimativas_8, estimativas_9, estimativas_10, estimativas_11, estimativas_12, pnadc)
  gc()
