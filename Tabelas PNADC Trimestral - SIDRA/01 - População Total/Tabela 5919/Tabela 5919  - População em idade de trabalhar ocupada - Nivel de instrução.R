...
calcula_ocup_desocup <- function(mesano){
  pnadc <- pnadc_design(read_pnadc(paste0("C:/Users/italo/Desktop/trimestral/txt/PNADC_0",mesano,".txt"), 
    ...
    update(
           ...
           ocupada1 = 1 * (VD4002 == 1 & VD3004 == 1),
           ocupada2 = 1 * (VD4002 == 1 & VD3004 == 2),
           ocupada3 = 1 * (VD4002 == 1 & VD3004 == 3),
           ocupada4 = 1 * (VD4002 == 1 & VD3004 == 4),
           ocupada5 = 1 * (VD4002 == 1 & VD3004 == 5),
           ocupada6 = 1 * (VD4002 == 1 & VD3004 == 6),
           ocupada7 = 1 * (VD4002 == 1 & VD3004 == 7),
  ...
  rm(estimativas_1, estimativas_2, estimativas_3, estimativas_4, estimativas_5, estimativas_6, estimativas_7, pnadc)
  gc()
...
mg<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                     ...
                                     13,26,39)], function(df) {
                                       data.frame(
                                         "Período" = as.character(df[11, 16]),
                                         "Total - Sem instrução e menos de 1 ano de estudo" = as.numeric(df[11,2]),
                                         "cv_1" = as.numeric(df[11,3]),
                                         "Total - Fundamental incompleto ou equivalente" = as.numeric(df[11, 4]),
                                         "cv_2" = as.numeric(df[11,5]),
                                         "Total - Fundamental completo ou equivalente" = as.numeric(df[11, 6]),
                                         "cv_3" = as.numeric(df[11,7]),
                                         "Total - Médio incompleto ou equivalente" = as.numeric(df[11,8]),
                                         "cv_4" = as.numeric(df[11,9]),
                                         "Total - Médio completo ou equivalente" = as.numeric(df[11,10]),
                                         "cv_5" = as.numeric(df[11,9]),
                                         "Total - Superior incompleto ou equivalente" = as.numeric(df[11,12]),
                                         "cv_6" = as.numeric(df[11,9]),
                                         "Total - Superior completo " = as.numeric(df[11,14]),
                                         "cv_7" = as.numeric(df[11,9])
                                       )
                                     }))
#View(mg)
...
entornobh<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                            ...
                                            13,26,39)], function(df) {
                                              data.frame(
                                                "Período" = as.character(df[2, 16]),
                                                "Total - Sem instrução e menos de 1 ano de estudo" = as.numeric(df[2,2]),
                                                "cv_1" = as.numeric(df[2,3]),
                                                "Total - Fundamental incompleto ou equivalente" = as.numeric(df[2, 4]),
                                                "cv_2" = as.numeric(df[2,5]),
                                                "Total - Fundamental completo ou equivalente" = as.numeric(df[2, 6]),
                                                "cv_3" = as.numeric(df[2,7]),
                                                "Total - Médio incompleto ou equivalente" = as.numeric(df[2,8]),
                                                "cv_4" = as.numeric(df[2,9]),
                                                "Total - Médio completo ou equivalente" = as.numeric(df[2,10]),
                                                "cv_5" = as.numeric(df[2,11]),
                                                "Total - Superior incompleto ou equivalente" = as.numeric(df[2,12]),
                                                "cv_6" = as.numeric(df[2,13]),
                                                "Total - Superior completo " = as.numeric(df[2,14]),
...
colarbh<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                          ...
                                          13,26,39)], function(df) {
                                            data.frame(
                                              "Período" = as.character(df[3, 16]),
                                              "Total - Sem instrução e menos de 1 ano de estudo" = as.numeric(df[3,2]),
                                              "cv_1" = as.numeric(df[3,3]),
                                              "Total - Fundamental incompleto ou equivalente" = as.numeric(df[3, 4]),
                                              "cv_2" = as.numeric(df[3,5]),
                                              "Total - Fundamental completo ou equivalente" = as.numeric(df[3, 6]),
                                              "cv_3" = as.numeric(df[3,7]),
                                              "Total - Médio incompleto ou equivalente" = as.numeric(df[3,8]),
                                              "cv_4" = as.numeric(df[3,9]),
                                              "Total - Médio completo ou equivalente" = as.numeric(df[3,10]),
                                              "cv_5" = as.numeric(df[3,11]),
                                              "Total - Superior incompleto ou equivalente" = as.numeric(df[3,12]),
                                              "cv_6" = as.numeric(df[3,13]),
                                              "Total - Superior completo " = as.numeric(df[3,14]),
...
RIDE<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                       ...
                                       13,26,39)], function(df) {
                                         data.frame(
                                           "Período" = as.character(df[4, 16]),
                                           "Total - Sem instrução e menos de 1 ano de estudo" = as.numeric(df[4,2]),
                                           "cv_1" = as.numeric(df[4,3]),
                                           "Total - Fundamental incompleto ou equivalente" = as.numeric(df[4, 4]),
                                           "cv_2" = as.numeric(df[4,5]),
                                           "Total - Fundamental completo ou equivalente" = as.numeric(df[4, 6]),
                                           "cv_3" = as.numeric(df[4,7]),
                                           "Total - Médio incompleto ou equivalente" = as.numeric(df[4,8]),
                                           "cv_4" = as.numeric(df[4,9]),
                                           "Total - Médio completo ou equivalente" = as.numeric(df[4,10]),
                                           "cv_5" = as.numeric(df[4,11]),
                                           "Total - Superior incompleto ou equivalente" = as.numeric(df[4,12]),
                                           "cv_6" = as.numeric(df[4,13]),
                                           "Total - Superior completo " = as.numeric(df[4,14]),
...
sulmg<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                        ...
                                        13,26,39)], function(df) {
                                          data.frame(
                                            "Período" = as.character(df[5, 16]),
                                            "Total - Sem instrução e menos de 1 ano de estudo" = as.numeric(df[5,2]),
                                            "cv_1" = as.numeric(df[5,3]),
                                            "Total - Fundamental incompleto ou equivalente" = as.numeric(df[5, 4]),
                                            "cv_2" = as.numeric(df[5,5]),
                                            "Total - Fundamental completo ou equivalente" = as.numeric(df[5, 6]),
                                            "cv_3" = as.numeric(df[5,7]),
                                            "Total - Médio incompleto ou equivalente" = as.numeric(df[5,8]),
                                            "cv_4" = as.numeric(df[5,9]),
                                            "Total - Médio completo ou equivalente" = as.numeric(df[5,10]),
                                            "cv_5" = as.numeric(df[5,11]),
                                            "Total - Superior incompleto ou equivalente" = as.numeric(df[5,12]),
                                            "cv_6" = as.numeric(df[5,13]),
                                            "Total - Superior completo " = as.numeric(df[5,14]),
...
trng<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                       ...
                                       13,26,39)], function(df) {
                                         data.frame(
                                           "Período" = as.character(df[6, 16]),
                                           "Total - Sem instrução e menos de 1 ano de estudo" = as.numeric(df[6,2]),
                                           "cv_1" = as.numeric(df[6,3]),
                                           "Total - Fundamental incompleto ou equivalente" = as.numeric(df[6, 4]),
                                           "cv_2" = as.numeric(df[6,5]),
                                           "Total - Fundamental completo ou equivalente" = as.numeric(df[6, 6]),
                                           "cv_3" = as.numeric(df[6,7]),
                                           "Total - Médio incompleto ou equivalente" = as.numeric(df[6,8]),
                                           "cv_4" = as.numeric(df[6,9]),
                                           "Total - Médio completo ou equivalente" = as.numeric(df[6,10]),
                                           "cv_5" = as.numeric(df[6,11]),
                                           "Total - Superior incompleto ou equivalente" = as.numeric(df[6,12]),
                                           "cv_6" = as.numeric(df[6,13]),
                                           "Total - Superior completo " = as.numeric(df[6,14]),
...
zonamata<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                           ...
                                           13,26,39)], function(df) {
                                             data.frame(
                                               "Período" = as.character(df[7, 16]),
                                               "Total - Sem instrução e menos de 1 ano de estudo" = as.numeric(df[7,2]),
                                               "cv_1" = as.numeric(df[7,3]),
                                               "Total - Fundamental incompleto ou equivalente" = as.numeric(df[7, 4]),
                                               "cv_2" = as.numeric(df[7,5]),
                                               "Total - Fundamental completo ou equivalente" = as.numeric(df[7, 6]),
                                               "cv_3" = as.numeric(df[7,7]),
                                               "Total - Médio incompleto ou equivalente" = as.numeric(df[7,8]),
                                               "cv_4" = as.numeric(df[7,9]),
                                               "Total - Médio completo ou equivalente" = as.numeric(df[7,10]),
                                               "cv_5" = as.numeric(df[7,11]),
                                               "Total - Superior incompleto ou equivalente" = as.numeric(df[7,12]),
                                               "cv_6" = as.numeric(df[7,13]),
                                               "Total - Superior completo " = as.numeric(df[7,14]),
...
nortemg<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                          ...
                                          13,26,39)], function(df) {
                                            data.frame(
                                              "Período" = as.character(df[8, 16]),
                                              "Total - Sem instrução e menos de 1 ano de estudo" = as.numeric(df[8,2]),
                                              "cv_1" = as.numeric(df[8,3]),
                                              "Total - Fundamental incompleto ou equivalente" = as.numeric(df[8, 4]),
                                              "cv_2" = as.numeric(df[8,5]),
                                              "Total - Fundamental completo ou equivalente" = as.numeric(df[8, 6]),
                                              "cv_3" = as.numeric(df[8,7]),
                                              "Total - Médio incompleto ou equivalente" = as.numeric(df[8,8]),
                                              "cv_4" = as.numeric(df[8,9]),
                                              "Total - Médio completo ou equivalente" = as.numeric(df[8,10]),
                                              "cv_5" = as.numeric(df[8,11]),
                                              "Total - Superior incompleto ou equivalente" = as.numeric(df[8,12]),
                                              "cv_6" = as.numeric(df[8,13]),
                                              "Total - Superior completo " = as.numeric(df[8,14]),
...
riodoce<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                          ...
                                          13,26,39)], function(df) {
                                            data.frame(
                                              "Período" = as.character(df[9, 16]),
                                              "Total - Sem instrução e menos de 1 ano de estudo" = as.numeric(df[9,2]),
                                              "cv_1" = as.numeric(df[9,3]),
                                              "Total - Fundamental incompleto ou equivalente" = as.numeric(df[9, 4]),
                                              "cv_2" = as.numeric(df[9,5]),
                                              "Total - Fundamental completo ou equivalente" = as.numeric(df[9, 6]),
                                              "cv_3" = as.numeric(df[9,7]),
                                              "Total - Médio incompleto ou equivalente" = as.numeric(df[9,8]),
                                              "cv_4" = as.numeric(df[9,9]),
                                              "Total - Médio completo ou equivalente" = as.numeric(df[9,10]),
                                              "cv_5" = as.numeric(df[9,11]),
                                              "Total - Superior incompleto ou equivalente" = as.numeric(df[9,12]),
                                              "cv_6" = as.numeric(df[9,13]),
                                              "Total - Superior completo " = as.numeric(df[9,14]),
...
central<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                          ...
                                          13,26,39)], function(df) {
                                            data.frame(
                                              "Período" = as.character(df[10, 16]),
                                              "Total - Sem instrução e menos de 1 ano de estudo" = as.numeric(df[10,2]),
                                              "cv_1" = as.numeric(df[10,3]),
                                              "Total - Fundamental incompleto ou equivalente" = as.numeric(df[10, 4]),
                                              "cv_2" = as.numeric(df[10,5]),
                                              "Total - Fundamental completo ou equivalente" = as.numeric(df[10, 6]),
                                              "cv_3" = as.numeric(df[10,7]),
                                              "Total - Médio incompleto ou equivalente" = as.numeric(df[10,8]),
                                              "cv_4" = as.numeric(df[10,9]),
                                              "Total - Médio completo ou equivalente" = as.numeric(df[10,10]),
                                              "cv_5" = as.numeric(df[10,11]),
                                              "Total - Superior incompleto ou equivalente" = as.numeric(df[10,12]),
                                              "cv_6" = as.numeric(df[10,13]),
                                              "Total - Superior completo " = as.numeric(df[10,14]),
