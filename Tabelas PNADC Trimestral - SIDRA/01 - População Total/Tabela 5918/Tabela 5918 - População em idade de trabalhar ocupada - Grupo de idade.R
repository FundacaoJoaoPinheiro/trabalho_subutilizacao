################################################################################
## LEITURA E ORGANIZAÇÃO DA PNADC TRIMESTRAL POR ESTRATOS GEOGRÁFICOS EM MG   ##
################################################################################
...
calcula_ocup_desocup <- function(mesano){
  pnadc <- pnadc_design(read_pnadc(paste0("C:/Users/italo/Desktop/trimestral/txt/PNADC_0",mesano,".txt"), 
     ...
     update(
           one = 1,
           ocupada1 = 1 * (one == 1 & (V2009 >= 0 & V2009 <= 13)),
           ocupada2 = 1 * (one == 1 & (V2009 >= 14 & V2009 <= 17)),
           ocupada3 = 1 * (one == 1 & (V2009 >= 18 & V2009 <= 24)),
           ocupada4 = 1 * (one == 1 & (V2009 >= 25 & V2009 <= 39)),
           ocupada5 = 1 * (one == 1 & (V2009 >= 40 & V2009 <= 59)),
           ocupada6 = 1 * (one == 1 & (V2009 >= 60)),
  ...
  rm(estimativas_1, estimativas_2, estimativas_3, estimativas_4, estimativas_5, estimativas_6, pnadc)
  gc()
...
mg<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                     ...
                                     13,26,39)], function(df) {
                                       data.frame(
                                         ...
                                         "Total - de0a13ano" = as.numeric(df[11, 4]),
                                         "cv" = as.numeric(df[11,5]),
                                         "Total - de14a17anos" = as.numeric(df[11, 6]),
                                         "cv" = as.numeric(df[11,7]),
                                         "Total - de18a24anos" = as.numeric(df[11,8]),
                                         "cv" = as.numeric(df[11,9]),
                                         "Total - de25a39anos" = as.numeric(df[11,10]),
                                         "cv" = as.numeric(df[11,11]),
                                         "Total - de40a59anos" = as.numeric(df[11,12]),
                                         "cv" = as.numeric(df[11,13]),
                                         "Total - de60+anos" = as.numeric(df[11,14]),
...
bh<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                     ...
                                     13,26,39)], function(df) {
                                       data.frame(
                                         ...
                                         "Total - de0a13ano" = as.numeric(df[1, 4]),
                                         "cv" = as.numeric(df[1,5]),
                                         "Total - de14a17anos" = as.numeric(df[1, 6]),
                                         "cv" = as.numeric(df[1,7]),
                                         "Total - de18a24anos" = as.numeric(df[1,8]),
                                         "cv" = as.numeric(df[1,9]),
                                         "Total - de25a39anos" = as.numeric(df[1,10]),
                                         "cv" = as.numeric(df[1,11]),
                                         "Total - de40a59anos" = as.numeric(df[1,12]),
                                         "cv" = as.numeric(df[1,13]),
                                         "Total - de60+anos" = as.numeric(df[1,14]),
...
entornobh<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                            ...
                                            13,26,39)], function(df) {
                                              data.frame(
                                                ...
                                                "Total - de0a13ano" = as.numeric(df[2, 4]),
                                                "cv" = as.numeric(df[2,5]),
                                                "Total - de14a17anos" = as.numeric(df[2, 6]),
                                                "cv" = as.numeric(df[2,7]),
                                                "Total - de18a24anos" = as.numeric(df[2,8]),
                                                "cv" = as.numeric(df[2,9]),
                                                "Total - de25a39anos" = as.numeric(df[2,10]),
                                                "cv" = as.numeric(df[2,11]),
                                                "Total - de40a59anos" = as.numeric(df[2,12]),
                                                "cv" = as.numeric(df[2,13]),
                                                "Total - de60+anos" = as.numeric(df[2,14]),
...
colarbh<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                          ...
                                          13,26,39)], function(df) {
                                            data.frame(
                                              ...
                                              "Total - de0a13ano" = as.numeric(df[3, 4]),
                                              "cv" = as.numeric(df[3,5]),
                                              "Total - de14a17anos" = as.numeric(df[3, 6]),
                                              "cv" = as.numeric(df[3,7]),
                                              "Total - de18a24anos" = as.numeric(df[3,8]),
                                              "cv" = as.numeric(df[3,9]),
                                              "Total - de25a39anos" = as.numeric(df[3,10]),
                                              "cv" = as.numeric(df[3,11]),
                                              "Total - de40a59anos" = as.numeric(df[3,12]),
                                              "cv" = as.numeric(df[3,13]),
                                              "Total - de60+anos" = as.numeric(df[3,14]),
...
RIDE<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                       ...
                                       13,26,39)], function(df) {
                                         data.frame(
                                           ...
                                           "Total - de0a13ano" = as.numeric(df[4, 4]),
                                           "cv" = as.numeric(df[4,5]),
                                           "Total - de14a17anos" = as.numeric(df[4, 6]),
                                           "cv" = as.numeric(df[4,7]),
                                           "Total - de18a24anos" = as.numeric(df[4,8]),
                                           "cv" = as.numeric(df[4,9]),
                                           "Total - de25a39anos" = as.numeric(df[4,10]),
                                           "cv" = as.numeric(df[4,11]),
                                           "Total - de40a59anos" = as.numeric(df[4,12]),
                                           "cv" = as.numeric(df[4,13]),
                                           "Total - de60+anos" = as.numeric(df[4,14]),
...
sulmg<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                        ...
                                        13,26,39)], function(df) {
                                          data.frame(
                                            ...
                                            "Total - de0a13ano" = as.numeric(df[5, 4]),
                                            "cv" = as.numeric(df[5,5]),
                                            "Total - de14a17anos" = as.numeric(df[5, 6]),
                                            "cv" = as.numeric(df[5,7]),
                                            "Total - de18a24anos" = as.numeric(df[5,8]),
                                            "cv" = as.numeric(df[5,9]),
                                            "Total - de25a39anos" = as.numeric(df[5,10]),
                                            "cv" = as.numeric(df[5,11]),
                                            "Total - de40a59anos" = as.numeric(df[5,12]),
                                            "cv" = as.numeric(df[5,13]),
                                            "Total - de60+anos" = as.numeric(df[5,14]),
...
trng<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                       ...
                                       13,26,39)], function(df) {
                                         data.frame(
                                           ...
                                           "Total - de0a13ano" = as.numeric(df[6, 4]),
                                           "cv" = as.numeric(df[6,5]),
                                           "Total - de14a17anos" = as.numeric(df[6, 6]),
                                           "cv" = as.numeric(df[6,7]),
                                           "Total - de18a24anos" = as.numeric(df[6,8]),
                                           "cv" = as.numeric(df[6,9]),
                                           "Total - de25a39anos" = as.numeric(df[6,10]),
                                           "cv" = as.numeric(df[6,11]),
                                           "Total - de40a59anos" = as.numeric(df[6,12]),
                                           "cv" = as.numeric(df[6,13]),
                                           "Total - de60+anos" = as.numeric(df[6,14]),
...
zonamata<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                           ...
                                           13,26,39)], function(df) {
                                             data.frame(
                                               ...
                                               "Total - de0a13ano" = as.numeric(df[7, 4]),
                                               "cv" = as.numeric(df[7,5]),
                                               "Total - de14a17anos" = as.numeric(df[7, 6]),
                                               "cv" = as.numeric(df[7,7]),
                                               "Total - de18a24anos" = as.numeric(df[7,8]),
                                               "cv" = as.numeric(df[7,9]),
                                               "Total - de25a39anos" = as.numeric(df[7,10]),
                                               "cv" = as.numeric(df[7,11]),
                                               "Total - de40a59anos" = as.numeric(df[7,12]),
                                               "cv" = as.numeric(df[7,13]),
                                               "Total - de60+anos" = as.numeric(df[7,14]),
...
nortemg<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                          ...
                                          13,26,39)], function(df) {
                                            data.frame(
                                              ...
                                              "Total - de0a13ano" = as.numeric(df[8, 4]),
                                              "cv" = as.numeric(df[8,5]),
                                              "Total - de14a17anos" = as.numeric(df[8, 6]),
                                              "cv" = as.numeric(df[8,7]),
                                              "Total - de18a24anos" = as.numeric(df[8,8]),
                                              "cv" = as.numeric(df[8,9]),
                                              "Total - de25a39anos" = as.numeric(df[8,10]),
                                              "cv" = as.numeric(df[8,11]),
                                              "Total - de40a59anos" = as.numeric(df[8,12]),
                                              "cv" = as.numeric(df[8,13]),
                                              "Total - de60+anos" = as.numeric(df[8,14]),
...
riodoce<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                          ...
                                          13,26,39)], function(df) {
                                            data.frame(
                                              ...
                                              "Total - de0a13ano" = as.numeric(df[9, 4]),
                                              "cv" = as.numeric(df[9,5]),
                                              "Total - de14a17anos" = as.numeric(df[9, 6]),
                                              "cv" = as.numeric(df[9,7]),
                                              "Total - de18a24anos" = as.numeric(df[9,8]),
                                              "cv" = as.numeric(df[9,9]),
                                              "Total - de25a39anos" = as.numeric(df[9,10]),
                                              "cv" = as.numeric(df[9,11]),
                                              "Total - de40a59anos" = as.numeric(df[9,12]),
                                              "cv" = as.numeric(df[9,13]),
                                              "Total - de60+anos" = as.numeric(df[9,14]),
...
central<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                          ...
                                          13,26,39)], function(df) {
                                            data.frame(
                                              ...
                                              "Total - de0a13ano" = as.numeric(df[10, 4]),
                                              "cv" = as.numeric(df[10,5]),
                                              "Total - de14a17anos" = as.numeric(df[10, 6]),
                                              "cv" = as.numeric(df[10,7]),
                                              "Total - de18a24anos" = as.numeric(df[10,8]),
                                              "cv" = as.numeric(df[10,9]),
                                              "Total - de25a39anos" = as.numeric(df[10,10]),
                                              "cv" = as.numeric(df[10,11]),
                                              "Total - de40a59anos" = as.numeric(df[10,12]),
                                              "cv" = as.numeric(df[10,13]),
                                              "Total - de60+anos" = as.numeric(df[10,14]),
...
saveRDS(baseestratatualidade,file = "C:/Users/italo/Desktop/trimestral/estimativas/baseestratatualidade.rds")
