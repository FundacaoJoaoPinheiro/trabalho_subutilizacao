...
mg<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                     ...
                                     13,26,39,52)], function(df) {
                                       data.frame(
                                         ...
                                         "Rend. médio mensal habitual - Trab principal - Homem " = as.numeric(df[11,4]),
                                         "cv_1" = as.numeric(df[11,5]),
                                         "Rend. médio mensal habitual - Trab principal - Mulher" = as.numeric(df[11,6]),
                                         "cv_2" = as.numeric(df[11,7]),
                                         
                                         "Rend. médio mensal efetivo - Trab principal - Total" = as.numeric(df[11,8]),
                                         "cv_t2" = as.numeric(df[11,9]),
                                         "Rend. médio mensal efetivo - Trab principal - Homem " = as.numeric(df[11,10]),
                                         "cv_3" = as.numeric(df[11,11]),
                                         "Rend. médio mensal efetivo - Trab principal - Mulher" = as.numeric(df[11,12]),
                                         "cv_4" = as.numeric(df[11,13]),
                                         
                                         "Rend. médio mensal habitual - Todos  os trabalhos - Total" = as.numeric(df[11,14]),
                                         "cv_t3" = as.numeric(df[11,15]),
                                         "Rend. médio mensal habitual - Todos  os trabalhos - Homem " = as.numeric(df[11,16]),
                                         "cv_5" = as.numeric(df[11,17]),
                                         "Rend. médio mensal habitual - Todos  os trabalhos - Mulher" = as.numeric(df[11,18]),
                                         "cv_6" = as.numeric(df[11,19]),
                                         
                                         "Rend. médio mensal efetivo - Todos  os trabalhos - Total" = as.numeric(df[11,20]),
                                         "cv_t4" = as.numeric(df[11,21]),
                                         "Rend. médio mensal efetivo - Todos  os trabalhos - Homem " = as.numeric(df[11,22]),
                                         "cv_7" = as.numeric(df[11,23]),
                                         "Rend. médio mensal efetivo - Todos  os trabalhos - Mulher" = as.numeric(df[11,24]),
                                         "cv_8" = as.numeric(df[11,25])
                                       )
                                     }))
#View(mg)
...
central<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                          ...
                                          13,26,39,52)], function(df) {
                                            data.frame(
                                              ...
                                              "Rend. médio mensal habitual - Trab principal - Homem " = as.numeric(df[10,4]),
                                              "cv_1" = as.numeric(df[10,5]),
                                              "Rend. médio mensal habitual - Trab principal - Mulher" = as.numeric(df[10,6]),
                                              "cv_2" = as.numeric(df[10,7]),
                                              
                                              "Rend. médio mensal efetivo - Trab principal - Total" = as.numeric(df[10,8]),
                                              "cv_t2" = as.numeric(df[10,9]),
                                              "Rend. médio mensal efetivo - Trab principal - Homem " = as.numeric(df[10,10]),
                                              "cv_3" = as.numeric(df[10,11]),
                                              "Rend. médio mensal efetivo - Trab principal - Mulher" = as.numeric(df[10,12]),
                                              "cv_4" = as.numeric(df[10,13]),
                                              
                                              "Rend. médio mensal habitual - Todos  os trabalhos - Total" = as.numeric(df[10,14]),
                                              "cv_t3" = as.numeric(df[10,15]),
                                              "Rend. médio mensal habitual - Todos  os trabalhos - Homem " = as.numeric(df[10,16]),
                                              "cv_5" = as.numeric(df[10,17]),
                                              "Rend. médio mensal habitual - Todos  os trabalhos - Mulher" = as.numeric(df[10,18]),
                                              "cv_6" = as.numeric(df[10,19]),
                                              
                                              "Rend. médio mensal efetivo - Todos  os trabalhos - Total" = as.numeric(df[10,20]),
                                              "cv_t4" = as.numeric(df[10,21]),
                                              "Rend. médio mensal efetivo - Todos  os trabalhos - Homem " = as.numeric(df[10,22]),
                                              "cv_7" = as.numeric(df[10,23]),
                                              "Rend. médio mensal efetivo - Todos  os trabalhos - Mulher" = as.numeric(df[10,24]),
                                              "cv_8" = as.numeric(df[10,25])
                                            )
                                          }))
