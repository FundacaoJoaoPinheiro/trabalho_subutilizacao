...
calcula_ocup_desocup <- function(mesano){
  pnadc <- pnadc_design(read_pnadc(paste0("C:/Users/italo/Desktop/trimestral/txt/PNADC_0",mesano,".txt"), 
                                   "C:/Users/italo/Desktop/trimestral/input/input_PNADC_trimestral.txt",vars=c("VD4002", "VD4003", "VD4004", "VD4010", "VD4011", "VD4007", "VD4009", "VD4001", "V2009", "VD4001", "V2007", "V2010", "VD3004", "V4076"))) %>%
  ...
  colnames(estimativas_1)[2]<-"txdesocupacao"
  ...
  total_1<- svyratio(~desocupados, denominator=~ft, subset(pnadc, UF=="31"),na.rm = TRUE)
  total_2<- svyratio(~num1, denominator=~ft, subset(pnadc, UF=="31"),na.rm = TRUE)
  total_3<- svyratio(~num2, denominator=~ftampliada, subset(pnadc,UF=="31"), na.rm = TRUE)
  total_4<- svyratio(~num3, denominator=~ftampliada, subset(pnadc,UF=="31"), na.rm = TRUE)
  ...
  total_mg<-tibble(
    ...
    txdesocupacao = coef(total_1),
    cv1 = round(cv(total_1)*100,1),
    
    tcdsiht = coef(total_2),
    cv2 = round(cv(total_2)*100,1),
    
    tcdftp = coef(total_3),
    cv3 = round(cv(total_3)*100,1),
    
    tcsft = coef(total_4),
    cv4 = round(cv(total_4)*100,1),
