...
mg<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                     ...
                                     13,26,39)], function(df) {
                                       data.frame(
                                         ...
                                         "Força de trabalho ampliada" = as.numeric(df[11,4]),
                                         "cv" = as.numeric(df[11,5]),
                                         "Desocupado ou na força de trabalho potencial ou subocupado por insuficiência de horas trabalhadas" = as.numeric(df[11, 6]),
                                         "cv" = as.numeric(df[11,7]),
                                         "Desocupado ou subocupado por insuficiência de horas trabalhadas" = as.numeric(df[11, 8]),
                                         "cv" = as.numeric(df[11,9]),
                                         "Desocupado" = as.numeric(df[11,10]),
                                         "cv" = as.numeric(df[11,11]),
                                         "Subocupado por insuficiência de horas trabalhadas" = as.numeric(df[11,12]),
                                         "cv" = as.numeric(df[11,13]),
                                         "Desocupado ou na força de trabalho potencial" = as.numeric(df[11,14]),
                                         "cv" = as.numeric(df[11,15]),
                                         "Força de trabalho potencial" = as.numeric(df[11,16]),
...
central<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                          ...
                                          13,26,39)], function(df) {
                                            data.frame(
                                              ...
                                              "Força de trabalho ampliada" = as.numeric(df[10,4]),
                                              "cv" = as.numeric(df[10,5]),
                                              "Desocupado ou na força de trabalho potencial ou subocupado por insuficiência de horas trabalhadas" = as.numeric(df[10, 6]),
                                              "cv" = as.numeric(df[10,7]),
                                              "Desocupado ou subocupado por insuficiência de horas trabalhadas" = as.numeric(df[10, 8]),
                                              "cv" = as.numeric(df[10,9]),
                                              "Desocupado" = as.numeric(df[10,10]),
                                              "cv" = as.numeric(df[10,1]),
                                              "Subocupado por insuficiência de horas trabalhadas" = as.numeric(df[10,12]),
                                              "cv" = as.numeric(df[10,13]),
                                              "Desocupado ou na força de trabalho potencial" = as.numeric(df[10,14]),
                                              "cv" = as.numeric(df[10,15]),
                                              "Força de trabalho potencial" = as.numeric(df[10,16]),
...
baseestratatualV4100<-list("01-Belo Horizonte"=bh,"02-Entorno metropolitano de BH"=entornobh,"03-Colar metropolitano de BH"=colarbh,
