...
mg<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                     ...
                                     13,26,39)], function(df) {
                                       data.frame(
                                         ...
                                         "Total - Força de Trabalho" = as.numeric(df[11,4]),
                                         "cv_1" = as.numeric(df[11,5]),
                                         "Total - Força de trabalho - ocupada" = as.numeric(df[11, 6]),
                                         "cv_2" = as.numeric(df[11,7]),
                                         "Total - Força de trabalho - desocupada" = as.numeric(df[11, 8]),
                                         "cv_3" = as.numeric(df[11,9]),
                                         "Total - Fora da força de trabalho - ocupada" = as.numeric(df[11,10]),
...
central<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                          ...
                                          13,26,39)], function(df) {
                                            data.frame(
                                              ...
                                              "Total - Força de Trabalho" = as.numeric(df[10,4]),
                                              "cv_1" = as.numeric(df[10,5]),
                                              "Total - Força de trabalho - ocupada" = as.numeric(df[10, 6]),
                                              "cv_2" = as.numeric(df[10,7]),
                                              "Total - Força de trabalho - desocupada" = as.numeric(df[10, 8]),
                                              "cv_3" = as.numeric(df[10,9]),
                                              "Total - Fora da força de trabalho - ocupada" = as.numeric(df[10,10]),
...
baseestratatualV4092<-list("01-Belo Horizonte"=bh,"02-Entorno metropolitano de BH"=entornobh,"03-Colar metropolitano de BH"=colarbh,
