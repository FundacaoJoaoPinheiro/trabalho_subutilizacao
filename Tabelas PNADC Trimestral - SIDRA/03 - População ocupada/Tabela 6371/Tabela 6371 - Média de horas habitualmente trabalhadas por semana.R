...
calcula_ocup_desocup <- function(mesano){
  pnadc <- pnadc_design(read_pnadc(paste0("C:/Users/italo/Desktop/trimestral/txt/PNADC_0",mesano,".txt"), 
    ...
    update(
      ...
      rend1 = as.numeric(VD4032),
      rend2 = as.numeric(VD4031),
      rend3 = as.numeric(VD4035),
      
      one1 = ifelse(pia %in% 1, rend1, NA),
      horasprincefetiv_h = ifelse(pia %in% 1 & V2007 %in% 1, rend1, NA),
      horasprincefetiv_m = ifelse(pia %in% 1 & V2007 %in% 2, rend1, NA),
      
      one2 = ifelse(pia %in% 1, rend2, NA),
      horastodoshabit_h = ifelse(pia %in% 1 & V2007 %in% 1, rend2, NA),
      horastodoshabit_m = ifelse(pia %in% 1 & V2007 %in% 2, rend2, NA),
      
      one3 = ifelse(pia %in% 1, rend3, NA),
      horastodosefetiv_h = ifelse(pia %in% 1 & V2007 %in% 1, rend3, NA),
      horastodosefetiv_m = ifelse(pia %in% 1 & V2007 %in% 2, rend3, NA),
  ...
  ## Total - Principal Efetivo Homem
  estimativas_1 <- svyby(~horasprincefetiv_h, by = ~regioes, subset(pnadc, UF =="31"), vartype="cv", na.rm = TRUE, svymean)
  colnames(estimativas_1)[3]<-"cv_1"
  
  ## Total - Principal Efetivo Mulher
  estimativas_2 <- svyby(~horasprincefetiv_m, by = ~regioes, subset(pnadc, UF =="31"), vartype="cv", na.rm = TRUE, svymean)
  ...
  ## Total - Todos Habitual Homem
  estimativas_3 <- svyby(~horastodoshabit_h, by = ~regioes, subset(pnadc, UF =="31"), vartype="cv", na.rm = TRUE, svymean)
  colnames(estimativas_3)[3]<-"cv_3"
  
  ## Total - Todos Habitual Mulher
  estimativas_4 <- svyby(~horastodoshabit_m, by = ~regioes, subset(pnadc, UF =="31"), vartype="cv", na.rm = TRUE, svymean)
  ...
  ## Total - Todos Efetivo Homem
  estimativas_5 <- svyby(~horastodosefetiv_h, by = ~regioes, subset(pnadc, UF =="31"), vartype="cv", na.rm = TRUE, svymean)
  colnames(estimativas_5)[3]<-"cv_5"
  
  ## Total - Todos Efetivo Mulher
  estimativas_6 <- svyby(~horastodosefetiv_m, by = ~regioes, subset(pnadc, UF =="31"), vartype="cv", na.rm = TRUE, svymean)
  ...
  total_1<- svymean(~horasprincefetiv_h, subset(pnadc,UF=="31"), na.rm = TRUE)
  total_2<- svymean(~horasprincefetiv_m, subset(pnadc,UF=="31"), na.rm = TRUE)
  total_3<- svymean(~horastodoshabit_h, subset(pnadc,UF=="31"), na.rm = TRUE)
  total_4<- svymean(~horastodoshabit_m, subset(pnadc,UF=="31"), na.rm = TRUE)
  total_5<- svymean(~horastodosefetiv_h, subset(pnadc,UF=="31"), na.rm = TRUE)
  total_6<- svymean(~horastodosefetiv_m, subset(pnadc,UF=="31"), na.rm = TRUE)
  ...
  rm(estimativas_t1, estimativas_t2, estimativas_t3, estimativas_1, estimativas_2, estimativas_3, estimativas_4, estimativas_5, estimativas_6, pnadc)
  gc()
