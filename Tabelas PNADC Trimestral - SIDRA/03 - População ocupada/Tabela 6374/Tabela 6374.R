...
lista <- c(032012,032013,032014,032015,032016,032017,032018,032019,032020,032021,032022,032023,032024,
...
mg<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                     ...
                                     11,24,37,50,
                                     12,25,38,51,
                                     13,39,52)], function(df) {
                                       data.frame(
                                         "Período" = as.character(df[11, 22]),
                                         "Total - habitualmente em todos os trabalhos" = as.numeric(df[11,2]),
                                         "cv" = as.numeric(df[11,3]),
                                         "Habitualmente em todos os trabalhos - Empregado" = as.numeric(df[11,4]),
                                         "cv" = as.numeric(df[11,5]),
                                         "Habitualmente em todos os trabalhos - Empregador" = as.numeric(df[11, 6]),
                                         "cv" = as.numeric(df[11,7]),
                                         "Habitualmente em todos os trabalhos - Conta própria" = as.numeric(df[11, 8]),
                                         "cv" = as.numeric(df[11,9]),
                                         "Habitualmente em todos os trabalhos - Trabalhador familiar auxiliar" = as.numeric(df[11,10]),
                                         "cv" = as.numeric(df[11,11]),
                                         
                                         
                                         
                                         "Total - efetivamente em todos os trabalhos" = as.numeric(df[11,12]),
                                         "cv" = as.numeric(df[11,13]),
                                         "Efetivamente em todos os trabalhos - Empregado" = as.numeric(df[11,14]),
                                         "cv" = as.numeric(df[11,15]),
                                         "Efetivamente em todos os trabalhos - Empregador" = as.numeric(df[11, 16]),
                                         "cv" = as.numeric(df[11,17]),
                                         "Efetivamente em todos os trabalhos - Conta própria" = as.numeric(df[11, 18]),
                                         "cv" = as.numeric(df[11,19]),
                                         "Efetivamente em todos os trabalhos - Trablhador Familiar Auxiliar" = as.numeric(df[11,20]),
...
central<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                          ...
                                          13,39,52)], function(df) {
                                            data.frame(
                                              "Período" = as.character(df[10, 22]),
                                              "Total - habitualmente em todos os trabalhos" = as.numeric(df[10,2]),
                                              "cv" = as.numeric(df[10,3]),
                                              "Habitualmente em todos os trabalhos - Empregado" = as.numeric(df[10,4]),
                                              "cv" = as.numeric(df[10,5]),
                                              "Habitualmente em todos os trabalhos - Empregador" = as.numeric(df[10, 6]),
                                              "cv" = as.numeric(df[10,7]),
                                              "Habitualmente em todos os trabalhos - Conta própria" = as.numeric(df[10, 8]),
                                              "cv" = as.numeric(df[10,9]),
                                              "Habitualmente em todos os trabalhos - Trabalhador familiar auxiliar" = as.numeric(df[10,10]),
                                              "cv" = as.numeric(df[10,11]),
                                              
                                              
                                              
                                              "Total - efetivamente em todos os trabalhos" = as.numeric(df[10,12]),
                                              "cv" = as.numeric(df[10,13]),
                                              "Efetivamente em todos os trabalhos - Empregado" = as.numeric(df[10,14]),
                                              "cv" = as.numeric(df[10,15]),
                                              "Efetivamente em todos os trabalhos - Empregador" = as.numeric(df[10, 16]),
                                              "cv" = as.numeric(df[10,17]),
                                              "Efetivamente em todos os trabalhos - Conta própria" = as.numeric(df[10, 18]),
                                              "cv" = as.numeric(df[10,19]),
                                              "Efetivamente em todos os trabalhos - Trablhador Familiar Auxiliar" = as.numeric(df[10,20]),
...
baseestratatualV6374<-list("01-Belo Horizonte"=bh,"02-Entorno metropolitano de BH"=entornobh,"03-Colar metropolitano de BH"=colarbh,
