...
calcula_ocup_desocup <- function(mesano){
  pnadc <- pnadc_design(read_pnadc(paste0("C:/Users/italo/Desktop/trimestral/txt/PNADC_0",mesano,".txt"), 
                                   "C:/Users/italo/Desktop/trimestral/input/input_PNADC_trimestral.txt",vars=c("VD4002", "VD4010", "VD4011", "VD4012", "VD4007", "VD4009", "VD4001", "V2009", "VD4001", "V2007", "V2010", "VD3004", "V4076"))) %>%
    
    update(
      #Criação das variáveis para população, conforme variável VD4007
      pia = as.numeric(V2009 >= 14) ,
      
      ocupada1 = 1 *(pia == 1 & VD4012=="1"),
      ocupada2 = 1 *(pia == 1 & VD4012=="2"),
...
mg<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                     ...
                                     13,26,39)], function(df) {
                                       data.frame(
                                         ...
                                         "Contribuintes" = as.numeric(df[11,4]),
                                         "cv" = as.numeric(df[11,5]),
                                         "Não contribuintes" = as.numeric(df[11, 6]),
...
bh<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                     ...
                                     13,26,39)], function(df) {
                                       data.frame(
                                         ...
                                         "Contribuintes" = as.numeric(df[1,4]),
                                         "cv" = as.numeric(df[1,5]),
                                         "Não contribuintes" = as.numeric(df[1, 6]),
...
entornobh<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                            ...
                                            13,26,39)], function(df) {
                                              data.frame(
                                                ...
                                                "Contribuintes" = as.numeric(df[2,4]),
                                                "cv" = as.numeric(df[2,5]),
                                                "Não contribuintes" = as.numeric(df[2, 6]),
...
colarbh<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                          ...
                                          13,26,39)], function(df) {
                                            data.frame(
                                              ...
                                              "Contribuintes" = as.numeric(df[3,4]),
                                              "cv" = as.numeric(df[3,5]),
                                              "Não contribuintes" = as.numeric(df[3, 6]),
...
RIDE<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                       ...
                                       13,26,39)], function(df) {
                                         data.frame(
                                           ...
                                           "Contribuintes" = as.numeric(df[4,4]),
                                           "cv" = as.numeric(df[4,5]),
                                           "Não contribuintes" = as.numeric(df[4, 6]),
...
sulmg<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                        ...
                                        13,26,39)], function(df) {
                                          data.frame(
                                            ...
                                            "Contribuintes" = as.numeric(df[5,4]),
                                            "cv" = as.numeric(df[5,5]),
                                            "Não contribuintes" = as.numeric(df[5, 6]),
...
trng<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                       ...
                                       13,26,39)], function(df) {
                                         data.frame(
                                           ...
                                           "Contribuintes" = as.numeric(df[6,4]),
                                           "cv" = as.numeric(df[6,5]),
                                           "Não contribuintes" = as.numeric(df[6, 6]),
...
zonamata<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                           ...
                                           13,26,39)], function(df) {
                                             data.frame(
                                               ...
                                               "Contribuintes" = as.numeric(df[7,4]),
                                               "cv" = as.numeric(df[7,5]),
                                               "Não contribuintes" = as.numeric(df[7, 6]),
...
nortemg<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                          ...
                                          13,26,39)], function(df) {
                                            data.frame(
                                              ...
                                              "Contribuintes" = as.numeric(df[8,4]),
                                              "cv" = as.numeric(df[8,5]),
                                              "Não contribuintes" = as.numeric(df[8, 6]),
...
riodoce<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                          ...
                                          13,26,39)], function(df) {
                                            data.frame(
                                              ...
                                              "Contribuintes" = as.numeric(df[9,4]),
                                              "cv" = as.numeric(df[9,5]),
                                              "Não contribuintes" = as.numeric(df[9, 6]),
...
central<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                          ...
                                          13,26,39)], function(df) {
                                            data.frame(
                                              ...
                                              "Contribuintes" = as.numeric(df[10,4]),
                                              "cv" = as.numeric(df[10,5]),
                                              "Não contribuintes" = as.numeric(df[1,0 6]),
...
baseestratatualV5947<-list("01-Belo Horizonte"=bh,"02-Entorno metropolitano de BH"=entornobh,"03-Colar metropolitano de BH"=colarbh,
...
saveRDS(baseestratatualV5947,file = "C:/Users/italo/Desktop/trimestral/baseestratatualV5947.rds")
