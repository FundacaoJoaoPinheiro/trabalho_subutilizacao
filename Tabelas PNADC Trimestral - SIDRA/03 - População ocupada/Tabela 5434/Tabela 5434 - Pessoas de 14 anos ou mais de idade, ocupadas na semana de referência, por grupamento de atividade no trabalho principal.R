...
#Tabela 5434 - Pessoas de 14 anos ou mais de idade, ocupadas na semana de referência, por grupamento de atividade no trabalho principal
...
calcula_ocup_desocup <- function(mesano){
  pnadc <- pnadc_design(read_pnadc(paste0("C:/Users/italo/Desktop/trimestral/txt/PNADC_0",mesano,".txt"), 
                                   "C:/Users/italo/Desktop/trimestral/input/input_PNADC_trimestral.txt",vars=c("VD4002", "VD4010", "VD4007", "VD4009", "VD4001", "V2009", "VD4001", "V2007", "V2010", "VD3004", "V4076"))) %>%
    
    update(
      #Criação das variáveis para população, conforme variável VD4007
      pia = as.numeric(V2009 >= 14) ,
      
      ocupada1 = 1 *(pia == 1 & VD4010=="01"),
      ocupada2 = 1 *(pia == 1 & VD4010=="02"),
      ocupada3 = 1 *(pia == 1 & VD4010=="03"),
      ocupada4 = 1 *(pia == 1 & VD4010=="04"),
      ocupada5 = 1 *(pia == 1 & VD4010=="05"),
      ocupada6 = 1 *(pia == 1 & VD4010=="06"),
      ocupada7 = 1 *(pia == 1 & VD4010=="07"),
      ocupada8 = 1 *(pia == 1 & (VD4010=="08" | VD4010=="09")),
      ocupada9 = 1 *(pia == 1 & VD4010=="10"),
      ocupada10 = 1 *(pia == 1 & VD4010=="11"),
      ocupada11 = 1 *(pia == 1 & VD4010=="12"),
  ...
  ## Total - Atividades mal definidas
...
mg<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                     ...
                                     13,26,39)], function(df) {
                                       data.frame(
                                         ...
                                         "Agricultura, pecuária, produção florestal, pesca e aquicultura" = as.numeric(df[11,4]),
                                         "cv" = as.numeric(df[11,5]),
                                         "Indústria geral" = as.numeric(df[11, 6]),
                                         "cv" = as.numeric(df[11,7]),
                                         "Construção" = as.numeric(df[11, 8]),
                                         "cv" = as.numeric(df[11,9]),
                                         "Comércio, reparação de veículos automotores e motocicletas" = as.numeric(df[11,10]),
                                         "cv" = as.numeric(df[11,11]),
                                         "Transporte, armazenagem e correio" = as.numeric(df[11,12]),
                                         "cv" = as.numeric(df[11,13]),
                                         "Alojamento e alimentação" = as.numeric(df[11,14]),
                                         "cv" = as.numeric(df[11,15]),
                                         "Informação, comunicação e atividades financeiras, imobiliárias, profissionais e administrativas" = as.numeric(df[11,16]),
                                         "cv" = as.numeric(df[11,17]),
                                         "Administração pública, defesa, seguridade social, educação, saúde humana e serviços sociais" = as.numeric(df[11,18]),
                                         "cv" = as.numeric(df[11,19]),
                                         "Outros serviços" = as.numeric(df[11,20]),
                                         "cv" = as.numeric(df[11,21]),
                                         "Serviços domésticos" = as.numeric(df[11,22]),
                                         "cv" = as.numeric(df[11,23]),
                                         "Atividades mal definidas" = as.numeric(df[11,24]),
...
bh<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                     ...
                                     13,26,39)], function(df) {
                                       data.frame(
                                         ...
                                         "Agricultura, pecuária, produção florestal, pesca e aquicultura" = as.numeric(df[1,4]),
                                         "cv" = as.numeric(df[1,5]),
                                         "Indústria geral" = as.numeric(df[1, 6]),
                                         "cv" = as.numeric(df[1,7]),
                                         "Construção" = as.numeric(df[1, 8]),
                                         "cv" = as.numeric(df[1,9]),
                                         "Comércio, reparação de veículos automotores e motocicletas" = as.numeric(df[1,10]),
                                         "cv" = as.numeric(df[1,11]),
                                         "Transporte, armazenagem e correio" = as.numeric(df[1,12]),
                                         "cv" = as.numeric(df[1,13]),
                                         "Alojamento e alimentação" = as.numeric(df[1,14]),
                                         "cv" = as.numeric(df[1,15]),
                                         "Informação, comunicação e atividades financeiras, imobiliárias, profissionais e administrativas" = as.numeric(df[1,16]),
                                         "cv" = as.numeric(df[1,17]),
                                         "Administração pública, defesa, seguridade social, educação, saúde humana e serviços sociais" = as.numeric(df[1,18]),
                                         "cv" = as.numeric(df[1,19]),
                                         "Outros serviços" = as.numeric(df[1,20]),
                                         "cv" = as.numeric(df[1,21]),
                                         "Serviços domésticos" = as.numeric(df[1,22]),
                                         "cv" = as.numeric(df[1,23]),
                                         "Atividades mal definidas" = as.numeric(df[1,24]),
...
entornobh<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                            ...
                                            13,26,39)], function(df) {
                                              data.frame(
                                                ...
                                                "Agricultura, pecuária, produção florestal, pesca e aquicultura" = as.numeric(df[2,4]),
                                                "cv" = as.numeric(df[2,5]),
                                                "Indústria geral" = as.numeric(df[2, 6]),
                                                "cv" = as.numeric(df[2,7]),
                                                "Construção" = as.numeric(df[2, 8]),
                                                "cv" = as.numeric(df[2,9]),
                                                "Comércio, reparação de veículos automotores e motocicletas" = as.numeric(df[2,10]),
                                                "cv" = as.numeric(df[2,11]),
                                                "Transporte, armazenagem e correio" = as.numeric(df[2,12]),
                                                "cv" = as.numeric(df[2,13]),
                                                "Alojamento e alimentação" = as.numeric(df[2,14]),
                                                "cv" = as.numeric(df[2,15]),
                                                "Informação, comunicação e atividades financeiras, imobiliárias, profissionais e administrativas" = as.numeric(df[2,16]),
                                                "cv" = as.numeric(df[2,17]),
                                                "Administração pública, defesa, seguridade social, educação, saúde humana e serviços sociais" = as.numeric(df[2,18]),
                                                "cv" = as.numeric(df[2,19]),
                                                "Outros serviços" = as.numeric(df[2,20]),
                                                "cv" = as.numeric(df[2,21]),
                                                "Serviços domésticos" = as.numeric(df[2,22]),
                                                "cv" = as.numeric(df[2,23]),
                                                "Atividades mal definidas" = as.numeric(df[2,24]),
...
colarbh<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                          ...
                                          13,26,39)], function(df) {
                                            data.frame(
                                              ...
                                              "Agricultura, pecuária, produção florestal, pesca e aquicultura" = as.numeric(df[3,4]),
                                              "cv" = as.numeric(df[3,5]),
                                              "Indústria geral" = as.numeric(df[3, 6]),
                                              "cv" = as.numeric(df[3,7]),
                                              "Construção" = as.numeric(df[3, 8]),
                                              "cv" = as.numeric(df[3,9]),
                                              "Comércio, reparação de veículos automotores e motocicletas" = as.numeric(df[3,10]),
                                              "cv" = as.numeric(df[3,11]),
                                              "Transporte, armazenagem e correio" = as.numeric(df[3,12]),
                                              "cv" = as.numeric(df[3,13]),
                                              "Alojamento e alimentação" = as.numeric(df[3,14]),
                                              "cv" = as.numeric(df[3,15]),
                                              "Informação, comunicação e atividades financeiras, imobiliárias, profissionais e administrativas" = as.numeric(df[3,16]),
                                              "cv" = as.numeric(df[3,17]),
                                              "Administração pública, defesa, seguridade social, educação, saúde humana e serviços sociais" = as.numeric(df[3,18]),
                                              "cv" = as.numeric(df[3,19]),
                                              "Outros serviços" = as.numeric(df[3,20]),
                                              "cv" = as.numeric(df[3,21]),
                                              "Serviços domésticos" = as.numeric(df[3,22]),
                                              "cv" = as.numeric(df[3,23]),
                                              "Atividades mal definidas" = as.numeric(df[3,24]),
...
RIDE<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                       ...
                                       13,26,39)], function(df) {
                                         data.frame(
                                           ...
                                           "Agricultura, pecuária, produção florestal, pesca e aquicultura" = as.numeric(df[4,4]),
                                           "cv" = as.numeric(df[4,5]),
                                           "Indústria geral" = as.numeric(df[4, 6]),
                                           "cv" = as.numeric(df[4,7]),
                                           "Construção" = as.numeric(df[4, 8]),
                                           "cv" = as.numeric(df[4,9]),
                                           "Comércio, reparação de veículos automotores e motocicletas" = as.numeric(df[4,10]),
                                           "cv" = as.numeric(df[4,11]),
                                           "Transporte, armazenagem e correio" = as.numeric(df[4,12]),
                                           "cv" = as.numeric(df[4,13]),
                                           "Alojamento e alimentação" = as.numeric(df[4,14]),
                                           "cv" = as.numeric(df[4,15]),
                                           "Informação, comunicação e atividades financeiras, imobiliárias, profissionais e administrativas" = as.numeric(df[4,16]),
                                           "cv" = as.numeric(df[4,17]),
                                           "Administração pública, defesa, seguridade social, educação, saúde humana e serviços sociais" = as.numeric(df[4,18]),
                                           "cv" = as.numeric(df[4,19]),
                                           "Outros serviços" = as.numeric(df[4,20]),
                                           "cv" = as.numeric(df[4,21]),
                                           "Serviços domésticos" = as.numeric(df[4,22]),
                                           "cv" = as.numeric(df[4,23]),
                                           "Atividades mal definidas" = as.numeric(df[4,24]),
...
sulmg<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                        ...
                                        13,26,39)], function(df) {
                                          data.frame(
                                            ...
                                            "Agricultura, pecuária, produção florestal, pesca e aquicultura" = as.numeric(df[5,4]),
                                            "cv" = as.numeric(df[5,5]),
                                            "Indústria geral" = as.numeric(df[5, 6]),
                                            "cv" = as.numeric(df[5,7]),
                                            "Construção" = as.numeric(df[5, 8]),
                                            "cv" = as.numeric(df[5,9]),
                                            "Comércio, reparação de veículos automotores e motocicletas" = as.numeric(df[5,10]),
                                            "cv" = as.numeric(df[5,11]),
                                            "Transporte, armazenagem e correio" = as.numeric(df[5,12]),
                                            "cv" = as.numeric(df[5,13]),
                                            "Alojamento e alimentação" = as.numeric(df[5,14]),
                                            "cv" = as.numeric(df[5,15]),
                                            "Informação, comunicação e atividades financeiras, imobiliárias, profissionais e administrativas" = as.numeric(df[5,16]),
                                            "cv" = as.numeric(df[5,17]),
                                            "Administração pública, defesa, seguridade social, educação, saúde humana e serviços sociais" = as.numeric(df[5,18]),
                                            "cv" = as.numeric(df[5,19]),
                                            "Outros serviços" = as.numeric(df[5,20]),
                                            "cv" = as.numeric(df[5,21]),
                                            "Serviços domésticos" = as.numeric(df[5,22]),
                                            "cv" = as.numeric(df[5,23]),
                                            "Atividades mal definidas" = as.numeric(df[5,24]),
...
trng<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                       ...
                                       13,26,39)], function(df) {
                                         data.frame(
                                           ...
                                           "Agricultura, pecuária, produção florestal, pesca e aquicultura" = as.numeric(df[6,4]),
                                           "cv" = as.numeric(df[6,5]),
                                           "Indústria geral" = as.numeric(df[6, 6]),
                                           "cv" = as.numeric(df[6,7]),
                                           "Construção" = as.numeric(df[6, 8]),
                                           "cv" = as.numeric(df[6,9]),
                                           "Comércio, reparação de veículos automotores e motocicletas" = as.numeric(df[6,10]),
                                           "cv" = as.numeric(df[6,11]),
                                           "Transporte, armazenagem e correio" = as.numeric(df[6,12]),
                                           "cv" = as.numeric(df[6,13]),
                                           "Alojamento e alimentação" = as.numeric(df[6,14]),
                                           "cv" = as.numeric(df[6,15]),
                                           "Informação, comunicação e atividades financeiras, imobiliárias, profissionais e administrativas" = as.numeric(df[6,16]),
                                           "cv" = as.numeric(df[6,17]),
                                           "Administração pública, defesa, seguridade social, educação, saúde humana e serviços sociais" = as.numeric(df[6,18]),
                                           "cv" = as.numeric(df[6,19]),
                                           "Outros serviços" = as.numeric(df[6,20]),
                                           "cv" = as.numeric(df[6,21]),
                                           "Serviços domésticos" = as.numeric(df[6,22]),
                                           "cv" = as.numeric(df[6,23]),
                                           "Atividades mal definidas" = as.numeric(df[6,24]),
...
zonamata<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                           ...
                                           13,26,39)], function(df) {
                                             data.frame(
                                               ...
                                               "Agricultura, pecuária, produção florestal, pesca e aquicultura" = as.numeric(df[7,4]),
                                               "cv" = as.numeric(df[7,5]),
                                               "Indústria geral" = as.numeric(df[7, 6]),
                                               "cv" = as.numeric(df[7,7]),
                                               "Construção" = as.numeric(df[7, 8]),
                                               "cv" = as.numeric(df[7,9]),
                                               "Comércio, reparação de veículos automotores e motocicletas" = as.numeric(df[7,10]),
                                               "cv" = as.numeric(df[7,11]),
                                               "Transporte, armazenagem e correio" = as.numeric(df[7,12]),
                                               "cv" = as.numeric(df[7,13]),
                                               "Alojamento e alimentação" = as.numeric(df[7,14]),
                                               "cv" = as.numeric(df[7,15]),
                                               "Informação, comunicação e atividades financeiras, imobiliárias, profissionais e administrativas" = as.numeric(df[7,16]),
                                               "cv" = as.numeric(df[7,17]),
                                               "Administração pública, defesa, seguridade social, educação, saúde humana e serviços sociais" = as.numeric(df[7,18]),
                                               "cv" = as.numeric(df[7,19]),
                                               "Outros serviços" = as.numeric(df[7,20]),
                                               "cv" = as.numeric(df[7,21]),
                                               "Serviços domésticos" = as.numeric(df[7,22]),
                                               "cv" = as.numeric(df[7,23]),
                                               "Atividades mal definidas" = as.numeric(df[7,24]),
...
nortemg<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                          ...
                                          13,26,39)], function(df) {
                                            data.frame(
                                              ...
                                              "Agricultura, pecuária, produção florestal, pesca e aquicultura" = as.numeric(df[8,4]),
                                              "cv" = as.numeric(df[8,5]),
                                              "Indústria geral" = as.numeric(df[8, 6]),
                                              "cv" = as.numeric(df[8,7]),
                                              "Construção" = as.numeric(df[8, 8]),
                                              "cv" = as.numeric(df[8,9]),
                                              "Comércio, reparação de veículos automotores e motocicletas" = as.numeric(df[8,10]),
                                              "cv" = as.numeric(df[8,11]),
                                              "Transporte, armazenagem e correio" = as.numeric(df[8,12]),
                                              "cv" = as.numeric(df[8,13]),
                                              "Alojamento e alimentação" = as.numeric(df[8,14]),
                                              "cv" = as.numeric(df[8,15]),
                                              "Informação, comunicação e atividades financeiras, imobiliárias, profissionais e administrativas" = as.numeric(df[8,16]),
                                              "cv" = as.numeric(df[8,17]),
                                              "Administração pública, defesa, seguridade social, educação, saúde humana e serviços sociais" = as.numeric(df[8,18]),
                                              "cv" = as.numeric(df[8,19]),
                                              "Outros serviços" = as.numeric(df[8,20]),
                                              "cv" = as.numeric(df[8,21]),
                                              "Serviços domésticos" = as.numeric(df[8,22]),
                                              "cv" = as.numeric(df[8,23]),
                                              "Atividades mal definidas" = as.numeric(df[8,24]),
...
riodoce<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                          ...
                                          13,26,39)], function(df) {
                                            data.frame(
                                              ...
                                              "Agricultura, pecuária, produção florestal, pesca e aquicultura" = as.numeric(df[9,4]),
                                              "cv" = as.numeric(df[9,5]),
                                              "Indústria geral" = as.numeric(df[9, 6]),
                                              "cv" = as.numeric(df[9,7]),
                                              "Construção" = as.numeric(df[9, 8]),
                                              "cv" = as.numeric(df[9,9]),
                                              "Comércio, reparação de veículos automotores e motocicletas" = as.numeric(df[9,10]),
                                              "cv" = as.numeric(df[9,11]),
                                              "Transporte, armazenagem e correio" = as.numeric(df[9,12]),
                                              "cv" = as.numeric(df[9,13]),
                                              "Alojamento e alimentação" = as.numeric(df[9,14]),
                                              "cv" = as.numeric(df[9,15]),
                                              "Informação, comunicação e atividades financeiras, imobiliárias, profissionais e administrativas" = as.numeric(df[9,16]),
                                              "cv" = as.numeric(df[9,17]),
                                              "Administração pública, defesa, seguridade social, educação, saúde humana e serviços sociais" = as.numeric(df[9,18]),
                                              "cv" = as.numeric(df[9,19]),
                                              "Outros serviços" = as.numeric(df[9,20]),
                                              "cv" = as.numeric(df[9,21]),
                                              "Serviços domésticos" = as.numeric(df[9,22]),
                                              "cv" = as.numeric(df[9,23]),
                                              "Atividades mal definidas" = as.numeric(df[9,24]),
...
central<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                          ...
                                          13,26,39)], function(df) {
                                            data.frame(
                                              ...
                                              "Agricultura, pecuária, produção florestal, pesca e aquicultura" = as.numeric(df[10,4]),
                                              "cv" = as.numeric(df[10,5]),
                                              "Indústria geral" = as.numeric(df[10, 6]),
                                              "cv" = as.numeric(df[10,7]),
                                              "Construção" = as.numeric(df[10, 8]),
                                              "cv" = as.numeric(df[10,9]),
                                              "Comércio, reparação de veículos automotores e motocicletas" = as.numeric(df[10,10]),
                                              "cv" = as.numeric(df[10,11]),
                                              "Transporte, armazenagem e correio" = as.numeric(df[10,12]),
                                              "cv" = as.numeric(df[10,13]),
                                              "Alojamento e alimentação" = as.numeric(df[10,14]),
                                              "cv" = as.numeric(df[10,15]),
                                              "Informação, comunicação e atividades financeiras, imobiliárias, profissionais e administrativas" = as.numeric(df[10,16]),
                                              "cv" = as.numeric(df[10,17]),
                                              "Administração pública, defesa, seguridade social, educação, saúde humana e serviços sociais" = as.numeric(df[10,18]),
                                              "cv" = as.numeric(df[10,19]),
                                              "Outros serviços" = as.numeric(df[10,20]),
                                              "cv" = as.numeric(df[10,21]),
                                              "Serviços domésticos" = as.numeric(df[10,22]),
                                              "cv" = as.numeric(df[10,23]),
                                              "Atividades mal definidas" = as.numeric(df[10,24]),
...
baseestratatualV5434<-list("01-Belo Horizonte"=bh,"02-Entorno metropolitano de BH"=entornobh,"03-Colar metropolitano de BH"=colarbh,
...
saveRDS(baseestratatualV5434,file = "C:/Users/italo/Desktop/trimestral/baseestratatualV5434.rds")
