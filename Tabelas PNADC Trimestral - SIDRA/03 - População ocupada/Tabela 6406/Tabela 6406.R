...
#Tabela 6406 - 	Média de horas habitualmente trabalhadas por semana e efetivamente trabalhadas na semana de referência, no trabalho principal e em todos os trabalhos, das pessoas de 14 anos ou mais de idade, por cor ou raça
library(PNADcIBGE)
library(survey)
library(tidyverse)
...
calcula_ocup_desocup <- function(mesano){
  pnadc <- pnadc_design(read_pnadc(paste0("C:/Users/italo/Desktop/trimestral/txt/PNADC_0",mesano,".txt"), 
    ...
    update(
      ...
      #Branca
      horastodoshabit_1 = ifelse(pia %in% 1  & (V2010==1), rend2, NA),
      horastodosefetiv_1 = ifelse(pia %in% 1 & (V2010==1), rend3, NA),
      
      #Preta
      horastodoshabit_2 = ifelse(pia %in% 1  & (V2010==2), rend2, NA),
      horastodosefetiv_2 = ifelse(pia %in% 1 & (V2010==2), rend3, NA),
      
      #Parda
      horastodoshabit_3 = ifelse(pia %in% 1  & (V2010==4), rend2, NA),
      horastodosefetiv_3 = ifelse(pia %in% 1 & (V2010==4), rend3, NA),
  ...
  ## Total - Branca
  estimativas_4 <- svyby(~horastodosefetiv_1, by = ~regioes, subset(pnadc, UF =="31"), vartype="cv", na.rm = TRUE, svymean)
  colnames(estimativas_4)[3]<-"cv_4"
  
  ## Total - Preta
  estimativas_5 <- svyby(~horastodosefetiv_2, by = ~regioes, subset(pnadc, UF =="31"), vartype="cv", na.rm = TRUE, svymean)
  colnames(estimativas_5)[3]<-"cv_5"
  
  ## Total - Parda
  estimativas_6 <- svyby(~horastodosefetiv_3, by = ~regioes, subset(pnadc, UF =="31"), vartype="cv", na.rm = TRUE, svymean)
  ...
  total_4<- svymean(~horastodosefetiv_1, subset(pnadc,UF=="31"), na.rm = TRUE)
  total_5<- svymean(~horastodosefetiv_2, subset(pnadc,UF=="31"), na.rm = TRUE)
  total_6<- svymean(~horastodosefetiv_3, subset(pnadc,UF=="31"), na.rm = TRUE)
  ...
  total_mg<-tibble(
    ...
    horastodosefetiv_1 = coef(total_4),
    cv_4 = round(cv(total_4)*100,1),
    
    horastodosefetiv_2 = coef(total_5),
    cv_5 = round(cv(total_5)*100,1),
    
    horastodosefetiv_3 = coef(total_6),
...
mg<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                     ...
                                     13,26,39,52)], function(df) {
                                       data.frame(
                                         ...
                                         "Habitualmente em todos os trabalhos - Branca" = as.numeric(df[11,4]),
                                         "cv" = as.numeric(df[11,5]),
                                         "Habitualmente em todos os trabalhos - Preta" = as.numeric(df[11, 6]),
                                         "cv" = as.numeric(df[11,7]),
                                         "Habitualmente em todos os trabalhos - Parda" = as.numeric(df[11, 8]),
                                         "cv" = as.numeric(df[11,9]),
        
                                         
                                         "Total - efetivamente em todos os trabalhos" = as.numeric(df[11,10]),
                                         "cv" = as.numeric(df[11,11]),
                                         "Efetivamente em todos os trabalhos - Branca" = as.numeric(df[11,12]),
                                         "cv" = as.numeric(df[11,13]),
                                         "Efetivamente em todos os trabalhos - Preta" = as.numeric(df[11,14]),
                                         "cv" = as.numeric(df[11,15]),
                                         "Efetivamente em todos os trabalhos - Parda" = as.numeric(df[11,16]),
...
bh<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                     ...
                                     13,26,39,52)], function(df) {
                                       data.frame(
                                         ...
                                         "Habitualmente em todos os trabalhos - Branca" = as.numeric(df[1,4]),
                                         "cv" = as.numeric(df[1,5]),
                                         "Habitualmente em todos os trabalhos - Preta" = as.numeric(df[1, 6]),
                                         "cv" = as.numeric(df[1,7]),
                                         "Habitualmente em todos os trabalhos - Parda" = as.numeric(df[1, 8]),
                                         "cv" = as.numeric(df[1,9]),
                                         
                                         
                                         "Total - efetivamente em todos os trabalhos" = as.numeric(df[1,10]),
                                         "cv" = as.numeric(df[1,11]),
                                         "Efetivamente em todos os trabalhos - Branca" = as.numeric(df[1,12]),
                                         "cv" = as.numeric(df[1,13]),
                                         "Efetivamente em todos os trabalhos - Preta" = as.numeric(df[1,14]),
                                         "cv" = as.numeric(df[1,15]),
                                         "Efetivamente em todos os trabalhos - Parda" = as.numeric(df[1,16]),
...
entornobh<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                            ...
                                            13,26,39,52)], function(df) {
                                              data.frame(
                                                ...
                                                "Habitualmente em todos os trabalhos - Branca" = as.numeric(df[2,4]),
                                                "cv" = as.numeric(df[2,5]),
                                                "Habitualmente em todos os trabalhos - Preta" = as.numeric(df[2, 6]),
                                                "cv" = as.numeric(df[2,7]),
                                                "Habitualmente em todos os trabalhos - Parda" = as.numeric(df[2, 8]),
                                                "cv" = as.numeric(df[2,9]),
                                                
                                                
                                                "Total - efetivamente em todos os trabalhos" = as.numeric(df[2,10]),
                                                "cv" = as.numeric(df[2,11]),
                                                "Efetivamente em todos os trabalhos - Branca" = as.numeric(df[2,12]),
                                                "cv" = as.numeric(df[2,13]),
                                                "Efetivamente em todos os trabalhos - Preta" = as.numeric(df[2,14]),
                                                "cv" = as.numeric(df[2,15]),
                                                "Efetivamente em todos os trabalhos - Parda" = as.numeric(df[2,16]),
...
colarbh<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                          ...
                                          13,26,39,52)], function(df) {
                                            data.frame(
                                              ...
                                              "Habitualmente em todos os trabalhos - Branca" = as.numeric(df[3,4]),
                                              "cv" = as.numeric(df[3,5]),
                                              "Habitualmente em todos os trabalhos - Preta" = as.numeric(df[3, 6]),
                                              "cv" = as.numeric(df[3,7]),
                                              "Habitualmente em todos os trabalhos - Parda" = as.numeric(df[3, 8]),
                                              "cv" = as.numeric(df[3,9]),
                                              
                                              
                                              "Total - efetivamente em todos os trabalhos" = as.numeric(df[3,10]),
                                              "cv" = as.numeric(df[3,11]),
                                              "Efetivamente em todos os trabalhos - Branca" = as.numeric(df[3,12]),
                                              "cv" = as.numeric(df[3,13]),
                                              "Efetivamente em todos os trabalhos - Preta" = as.numeric(df[3,14]),
                                              "cv" = as.numeric(df[3,15]),
                                              "Efetivamente em todos os trabalhos - Parda" = as.numeric(df[3,16]),
...
RIDE<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                       ...
                                       13,26,39,52)], function(df) {
                                         data.frame(
                                           ...
                                           "Habitualmente em todos os trabalhos - Branca" = as.numeric(df[4,4]),
                                           "cv" = as.numeric(df[4,5]),
                                           "Habitualmente em todos os trabalhos - Preta" = as.numeric(df[4, 6]),
                                           "cv" = as.numeric(df[4,7]),
                                           "Habitualmente em todos os trabalhos - Parda" = as.numeric(df[4, 8]),
                                           "cv" = as.numeric(df[4,9]),
                                           
                                           
                                           "Total - efetivamente em todos os trabalhos" = as.numeric(df[4,10]),
                                           "cv" = as.numeric(df[4,11]),
                                           "Efetivamente em todos os trabalhos - Branca" = as.numeric(df[4,12]),
                                           "cv" = as.numeric(df[4,13]),
                                           "Efetivamente em todos os trabalhos - Preta" = as.numeric(df[4,14]),
                                           "cv" = as.numeric(df[4,15]),
                                           "Efetivamente em todos os trabalhos - Parda" = as.numeric(df[4,16]),
...
sulmg<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                        ...
                                        13,26,39,52)], function(df) {
                                          data.frame(
                                            ...
                                            "Habitualmente em todos os trabalhos - Branca" = as.numeric(df[5,4]),
                                            "cv" = as.numeric(df[5,5]),
                                            "Habitualmente em todos os trabalhos - Preta" = as.numeric(df[5, 6]),
                                            "cv" = as.numeric(df[5,7]),
                                            "Habitualmente em todos os trabalhos - Parda" = as.numeric(df[5, 8]),
                                            "cv" = as.numeric(df[5,9]),
                                            
                                            
                                            "Total - efetivamente em todos os trabalhos" = as.numeric(df[5,10]),
                                            "cv" = as.numeric(df[5,11]),
                                            "Efetivamente em todos os trabalhos - Branca" = as.numeric(df[5,12]),
                                            "cv" = as.numeric(df[5,13]),
                                            "Efetivamente em todos os trabalhos - Preta" = as.numeric(df[5,14]),
                                            "cv" = as.numeric(df[5,15]),
                                            "Efetivamente em todos os trabalhos - Parda" = as.numeric(df[5,16]),
...
trng<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                       ...
                                       13,26,39,52)], function(df) {
                                         data.frame(
                                           ...
                                           "Habitualmente em todos os trabalhos - Branca" = as.numeric(df[6,4]),
                                           "cv" = as.numeric(df[6,5]),
                                           "Habitualmente em todos os trabalhos - Preta" = as.numeric(df[6, 6]),
                                           "cv" = as.numeric(df[6,7]),
                                           "Habitualmente em todos os trabalhos - Parda" = as.numeric(df[6, 8]),
                                           "cv" = as.numeric(df[6,9]),
                                           
                                           
                                           "Total - efetivamente em todos os trabalhos" = as.numeric(df[6,10]),
                                           "cv" = as.numeric(df[6,11]),
                                           "Efetivamente em todos os trabalhos - Branca" = as.numeric(df[6,12]),
                                           "cv" = as.numeric(df[6,13]),
                                           "Efetivamente em todos os trabalhos - Preta" = as.numeric(df[6,14]),
                                           "cv" = as.numeric(df[6,15]),
                                           "Efetivamente em todos os trabalhos - Parda" = as.numeric(df[6,16]),
...
zonamata<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                           ...
                                           13,26,39,52)], function(df) {
                                             data.frame(
                                               ...
                                               "Habitualmente em todos os trabalhos - Branca" = as.numeric(df[7,4]),
                                               "cv" = as.numeric(df[7,5]),
                                               "Habitualmente em todos os trabalhos - Preta" = as.numeric(df[7, 6]),
                                               "cv" = as.numeric(df[7,7]),
                                               "Habitualmente em todos os trabalhos - Parda" = as.numeric(df[7, 8]),
                                               "cv" = as.numeric(df[7,9]),
                                               
                                               
                                               "Total - efetivamente em todos os trabalhos" = as.numeric(df[7,10]),
                                               "cv" = as.numeric(df[7,11]),
                                               "Efetivamente em todos os trabalhos - Branca" = as.numeric(df[7,12]),
                                               "cv" = as.numeric(df[7,13]),
                                               "Efetivamente em todos os trabalhos - Preta" = as.numeric(df[7,14]),
                                               "cv" = as.numeric(df[7,15]),
                                               "Efetivamente em todos os trabalhos - Parda" = as.numeric(df[7,16]),
...
nortemg<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                          ...
                                          13,26,39,52)], function(df) {
                                            data.frame(
                                              ...
                                              "Habitualmente em todos os trabalhos - Branca" = as.numeric(df[8,4]),
                                              "cv" = as.numeric(df[8,5]),
                                              "Habitualmente em todos os trabalhos - Preta" = as.numeric(df[8, 6]),
                                              "cv" = as.numeric(df[8,7]),
                                              "Habitualmente em todos os trabalhos - Parda" = as.numeric(df[8, 8]),
                                              "cv" = as.numeric(df[8,9]),
                                              
                                              
                                              "Total - efetivamente em todos os trabalhos" = as.numeric(df[8,10]),
                                              "cv" = as.numeric(df[8,11]),
                                              "Efetivamente em todos os trabalhos - Branca" = as.numeric(df[8,12]),
                                              "cv" = as.numeric(df[8,13]),
                                              "Efetivamente em todos os trabalhos - Preta" = as.numeric(df[8,14]),
                                              "cv" = as.numeric(df[8,15]),
                                              "Efetivamente em todos os trabalhos - Parda" = as.numeric(df[8,16]),
...
riodoce<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                          ...
                                          13,26,39,52)], function(df) {
                                            data.frame(
                                              ...
                                              "Habitualmente em todos os trabalhos - Branca" = as.numeric(df[9,4]),
                                              "cv" = as.numeric(df[9,5]),
                                              "Habitualmente em todos os trabalhos - Preta" = as.numeric(df[9, 6]),
                                              "cv" = as.numeric(df[9,7]),
                                              "Habitualmente em todos os trabalhos - Parda" = as.numeric(df[9, 8]),
                                              "cv" = as.numeric(df[9,9]),
                                              
                                              
                                              "Total - efetivamente em todos os trabalhos" = as.numeric(df[9,10]),
                                              "cv" = as.numeric(df[9,11]),
                                              "Efetivamente em todos os trabalhos - Branca" = as.numeric(df[9,12]),
                                              "cv" = as.numeric(df[9,13]),
                                              "Efetivamente em todos os trabalhos - Preta" = as.numeric(df[9,14]),
                                              "cv" = as.numeric(df[9,15]),
                                              "Efetivamente em todos os trabalhos - Parda" = as.numeric(df[9,16]),
...
central<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                          ...
                                          13,26,39,52)], function(df) {
                                            data.frame(
                                              ...
                                              "Habitualmente em todos os trabalhos - Branca" = as.numeric(df[10,4]),
                                              "cv" = as.numeric(df[10,5]),
                                              "Habitualmente em todos os trabalhos - Preta" = as.numeric(df[10, 6]),
                                              "cv" = as.numeric(df[10,7]),
                                              "Habitualmente em todos os trabalhos - Parda" = as.numeric(df[10, 8]),
                                              "cv" = as.numeric(df[10,9]),
                                              
                                              
                                              "Total - efetivamente em todos os trabalhos" = as.numeric(df[10,10]),
                                              "cv" = as.numeric(df[10,11]),
                                              "Efetivamente em todos os trabalhos - Branca" = as.numeric(df[10,12]),
                                              "cv" = as.numeric(df[10,13]),
                                              "Efetivamente em todos os trabalhos - Preta" = as.numeric(df[10,14]),
                                              "cv" = as.numeric(df[10,15]),
                                              "Efetivamente em todos os trabalhos - Parda" = as.numeric(df[10,16]),
...
baseestratatualV6406<-list("01-Belo Horizonte"=bh,"02-Entorno metropolitano de BH"=entornobh,"03-Colar metropolitano de BH"=colarbh,
...
saveRDS(baseestratatualV6406,file = "C:/Users/italo/Desktop/trimestral/baseestratatualV6406.rds")
