...
mg<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                     ...
                                     13,26,39)], function(df) {
                                       data.frame(
                                         ...
                                         "Total de homens ocupados" = as.numeric(df[11, 4]),
                                         "cv" = as.numeric(df[11,5]),
                                         "Taxa de mulheres ocupadas" = as.numeric(df[11, 6]),
...
central<-do.call(rbind, lapply(pnadcrds[c(1,14,27,40,
                                          ...
                                          13,26,39)], function(df) {
                                            data.frame(
                                              ...
                                              "Total de homens ocupados" = as.numeric(df[10, 4]),
                                              "cv" = as.numeric(df[10,5]),
                                              "Taxa de mulheres ocupadas" = as.numeric(df[10, 6]),
