...
Pessoas de 14 anos ou mais de idade, ocupadas na semana de referência, por tempo de permanência no trabalho principal
...
```{r}
ocup_tempo <- svyby(~ocupados,by = ~estratos_geogr+V4040, subset(dadosPNADc,UF=="Minas Gerais"), svytotal,na.rm = TRUE)

ocup_tempocv <- round(cv(svyby(~ocupados,by = ~estratos_geogr+V4040, subset(dadosPNADc,UF=="Minas Gerais"), svytotal,na.rm = TRUE))*100,1)

knitr::kable(ocup_tempo ,
             caption = "Pessoas de 14 anos ou mais de idade, ocupadas na semana de referência, por tempo de permanência no trabalho principal, por estrato geográfico")

knitr::kable(ocup_tempocv,
             caption = "Pessoas de 14 anos ou mais de idade, ocupadas na semana de referência, por tempo de permanência no trabalho principal, por estrato geográfico")
```