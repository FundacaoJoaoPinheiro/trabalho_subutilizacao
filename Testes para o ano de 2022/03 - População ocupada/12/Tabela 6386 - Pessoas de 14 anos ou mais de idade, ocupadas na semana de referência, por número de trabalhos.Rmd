...
Pessoas de 14 anos ou mais de idade, ocupadas na semana de referência, por número de trabalhos
...
```{r}
ocup_qnt <- svyby(~ocupados,by = ~estratos_geogr+V4009, subset(dadosPNADc,UF=="Minas Gerais"), svytotal,na.rm = TRUE)

ocup_qntcv <- round(cv(svyby(~ocupados,by = ~estratos_geogr+V4009, subset(dadosPNADc,UF=="Minas Gerais"), svytotal,na.rm = TRUE))*100,1)

knitr::kable(ocup_qnt,
             caption = "Pessoas de 14 anos ou mais de idade, ocupadas na semana de referência, por número de trabalhos, por estrato geográfico")

knitr::kable(ocup_qntcv,
             caption = "Coeficiente de variação - Pessoas de 14 anos ou mais de idade, ocupadas na semana de referência, por número de trabalhos, por estrato geográfico")
```