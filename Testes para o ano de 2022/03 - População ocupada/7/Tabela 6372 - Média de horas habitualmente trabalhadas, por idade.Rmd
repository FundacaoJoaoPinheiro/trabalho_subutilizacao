...
Tabela - Media de horas habitualmente trabalhadas por semana e efetivamente trabalhadas na semana de referencia, no trabalho principal e em todos os trabalhos, das pessoas de 14 anos ou mais de idade, por idade
...
```
#Tabela 6372 - Media de horas habitualmente trabalhadas por semana e efetivamente trabalhadas na semana de referencia, no trabalho principal e em todos os trabalhos, das pessoas de 14 anos ou mais de idade, por idade

#Tabela 6372 - Media de horas habitualmente trabalhadas por semana e efetivamente trabalhadas na semana de referencia, no trabalho principal e em todos os trabalhos, das pessoas de 14 anos ou mais de idade, de 14 a 29 anos


```{r}
mediahoras1 <- coef(svyby(~VD4031,by = ~estratos_geogr+faixa_idade, subset(dadosPNADc,UF=="Minas Gerais"), svymean,na.rm = TRUE))
mediahoras1cv <- round(cv(svyby(~VD4031,by = ~estratos_geogr+faixa_idade, subset(dadosPNADc,UF=="Minas Gerais"), svymean,na.rm = TRUE))*100,1)


knitr::kable(mediahoras1,
             caption = "Media de horas habitualmente trabalhadas por semana e efetivamente trabalhadas na semana de referencia, no trabalho principal e em todos os trabalhos, das pessoas de 14 anos ou mais de idade, por estrato geográfico")

knitr::kable(mediahoras1cv,
             caption = "Coeficiente de variação - Media de horas habitualmente trabalhadas por semana e efetivamente trabalhadas na semana de referencia, no trabalho principal e em todos os trabalhos, por estrato geográfico")
```
