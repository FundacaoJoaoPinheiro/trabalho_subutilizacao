...
Tabela 6373 - Media de horas habitualmente trabalhadas por semana e efetivamente trabalhadas na semana de referencia, no trabalho principal e em todos os trabalhos, das pessoas de 14 anos ou mais de idade, por nível de insstrução
...
```
#Tabela 6373 - Media de horas habitualmente trabalhadas por semana e efetivamente trabalhadas na semana de referencia, no trabalho principal e em todos os trabalhos, das pessoas de 14 anos ou mais de idade, por nível de instrução

#Tabela 6373 - Media de horas habitualmente trabalhadas por semana e efetivamente trabalhadas na semana de referencia, no trabalho principal e em todos os trabalhos, das pessoas de 14 anos ou mais de idade, por nível de instrução


```{r}
mediahoras1 <- coef(svyby(~VD4031,by = ~estratos_geogr+VD3004, subset(dadosPNADc,UF=="Minas Gerais"), svymean,na.rm = TRUE))
mediahoras1cv <- round(cv(svyby(~VD4031,by = ~estratos_geogr+VD3004, subset(dadosPNADc,UF=="Minas Gerais"), svymean,na.rm = TRUE))*100,1)


knitr::kable(mediahoras1,
             caption = "Media de horas habitualmente trabalhadas por semana e efetivamente trabalhadas na semana de referencia, no trabalho principal e em todos os trabalhos, por nível de instrução, por estrato geográfico")

knitr::kable(mediahoras1cv,
             caption = "Coeficiente de variação - Media de horas habitualmente trabalhadas por semana e efetivamente trabalhadas na semana de referencia, no trabalho principal e em todos os trabalhos, por nível de instrução, por estrato geográfico")
```
