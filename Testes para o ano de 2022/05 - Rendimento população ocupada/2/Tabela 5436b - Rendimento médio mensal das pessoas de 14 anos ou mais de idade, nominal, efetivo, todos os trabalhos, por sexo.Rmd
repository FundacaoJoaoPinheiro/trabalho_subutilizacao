...
# Calcular a Massa de rendimento mensal nominal efetiva (VD4020)
...
# Calcular a Massa de rendimento mensal nominal média efetiva (VD4020)
...
#Calcular a Massa de rendimento mensal nominal média efetiva (VD4020), para homens ocupados
...
knitr::kable(media_massa_nominal_hcv,
             caption = "Coeficiente de variação - Massa de rendimento mensal nominal média efetivamente recebida - homens ocupados, por estratos geográficos - Minas Gerais - 2022")
```

#Calcular a Massa de rendimento mensal nominal média efetiva (VD4020), para mulheres ocupadas
...
knitr::kable(media_massa_nominal_mcv,
             caption = "Coeficiente de variação - Massa de rendimento mensal nominal média efetivamente recebida - mulheres ocupadas, por estratos geográficos - Minas Gerais - 2022")
```