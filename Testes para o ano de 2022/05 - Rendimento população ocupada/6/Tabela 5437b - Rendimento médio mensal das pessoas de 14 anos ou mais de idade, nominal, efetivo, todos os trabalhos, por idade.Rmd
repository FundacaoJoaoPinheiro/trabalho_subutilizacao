...
#Calcular o rendimento médio mensal nominal efetivo, em todos os trabalhos, por grupo de idade, nos estratos geográficos
...
knitr::kable(media_massa_nominal_idade,
             caption = "Massa de rendimento mensal nominal média efetivamente recebida - por faixa de idade, por estratos geográficos - Minas Gerais - 2022 - Todos os trabalhos")

knitr::kable(media_massa_nominal_idadecv,
             caption = "Coeficiente de variação - Massa de rendimento mensal nominal média efetivamente recebida - por faixa de idade, por estratos geográficos - Minas Gerais - 2022 - Todos os trabalhos")
