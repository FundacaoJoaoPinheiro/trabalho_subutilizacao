...
Qual a população, por grupo de idade, se considerados os estratos geográficos para Minas Gerais no ano de 2022?
...
População, por grupo de idade - Conforme divisão dos estratos geográficos

A tabela a seguir apresenta a população, separadas por grupo de idade, para cada estrato geográfico de Minas Gerais no respectivo ano em questão. Salienta-se que os recortes de idade estão estabelecidos no código acima. 


```{r}
total_grupoidade <- svytotal(x=~interaction(faixa_idade,estratos_geogr), design=dadosPNADc, na.rm=TRUE)

total_grupoidadecv <- round(cv(svytotal(x=~interaction(faixa_idade,estratos_geogr), design=dadosPNADc, na.rm=TRUE))*100,1)

knitr::kable(total_grupoidade,
              caption = "População, por grupo de idade - conforme estratos geográficos - Minas Gerais - 2022")

knitr::kable(total_grupoidadecv,
              caption = "Coeficiente de variação - População, por grupo de idade - conforme estratos geográficos - Minas Gerais - 2022")
```
