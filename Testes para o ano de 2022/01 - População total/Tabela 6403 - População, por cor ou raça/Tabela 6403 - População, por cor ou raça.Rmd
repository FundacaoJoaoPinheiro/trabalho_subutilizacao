...
Qual a população, por cor ou raça, conforme os estratos geográficos para Minas Gerais no ano de 2022?
...
População, por cor ou raça - Conforme divisão dos estratos geográficos

A tabela a seguir apresenta a população por raça ou cor, conforme os estratos geográficos para Minas Gerais, no ano de 2022. A categorização por estratos é permeada pela cor ou raça declarada pelo indivíduo, conforme escala apresentada. 


```{r}
total_racacor <- svytotal(x=~interaction(raca_cor,estratos_geogr), design=dadosPNADc, na.rm=TRUE)

total_racacorcv <- round(cv(svytotal(x=~interaction(raca_cor,estratos_geogr), design=dadosPNADc, na.rm=TRUE))*100,1)
knitr::kable(total_racacor,
              caption = "População, por cor ou raça - conforme estratos geográficos - Minas Gerais - 2022")

knitr::kable(total_racacorcv,
              caption = "Coeficiente de variação - População, por cor ou raça - conforme estratos geográficos - Minas Gerais - 2022")
```
