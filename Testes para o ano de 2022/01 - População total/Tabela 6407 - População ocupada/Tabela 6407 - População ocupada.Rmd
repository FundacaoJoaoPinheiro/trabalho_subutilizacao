...
Qual a população total, conforme os estratos geográficos de Minas Gerais para o ano de 2022?
...
População total - Conforme divisão dos estratos geográficos

De forma a calcular a população, por estrato geográfico, utiliza-se a variável V2009 (que é a correspondente à idade, no respectivo dicionário de microdados da PNADc anual). Utiliza-se o parâmetro interaction para correlacionar somente indivíduos com idade igual ou superior a 14 anos, separados por estrato geográfico.


```{r}
total_idade <- svytotal(x=~interaction(V2009>=14, estratos_geogr), design=dadosPNADc, na.rm=TRUE)

total_idadecv <- round(cv(svytotal(x=~interaction(V2009>=14, estratos_geogr), design=dadosPNADc, na.rm=TRUE))*100,1)

knitr::kable(total_idade,
             caption = "População ocupada com idade acima de 14 anos - conforme estratos geográficos - Minas Gerais - 2022")

knitr::kable(total_idadecv,
             caption = "Coeficiente de variação - População ocupada com idade acima de 14 anos - conforme estratos geográficos - Minas Gerais - 2022")
```
