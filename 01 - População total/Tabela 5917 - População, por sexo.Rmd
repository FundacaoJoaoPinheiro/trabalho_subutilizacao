...
População, por sexo - Conforme divisão dos estratos geográficos


```{r}
total_sexo <- svytotal(x=~interaction(V2007,estratos_geogr), design=dadosPNADc, na.rm=TRUE)
total_sexocv <- round(cv(svytotal(x=~interaction(V2007,estratos_geogr), design=dadosPNADc, na.rm=TRUE))*100,1)
knitr::kable(total_sexo,
             caption = "População, por sexo - conforme estratos geográficos - Minas Gerais - 2022")

knitr::kable(total_sexocv,
             caption = "Coeficiente de variação - População, por sexo - conforme estratos geográficos - Minas Gerais - 2022")
```
