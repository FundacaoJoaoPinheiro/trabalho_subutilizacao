...
Qual a população, por nível de instrução, conforme estratos geográficos de Minas Gerais para o ano de 2022? 
...
options(survey.lonely.psu = "adjust", encoding = "latin1")
...
População, por nível de instrução - Conforme divisão dos estratos geográficos

A tabela a seguir apresenta a população, por nível de instrução, conforme os estratos geográficos para Minas Gerais no ano de 2022. Destaca-se que a variável VD3004 é a que representa os níveis de instrução, na PNADC-Anual, no período em destaque.


```{r}
total_nivelinstr <- svytotal(x=~interaction(VD3004,estratos_geogr), design=dadosPNADc, na.rm=TRUE)
total_nivelinstrcv <- round(cv(svytotal(x=~interaction(VD3004,estratos_geogr), design=dadosPNADc, na.rm=TRUE))*100,1)
knitr::kable(total_nivelinstr,
              caption = "População, por nível de instrução - conforme estratos geográficos - Minas Gerais - 2022")

knitr::kable(total_nivelinstrcv,
              caption = "Coeficiente de variação - População, por nível de instrução - conforme estratos geográficos - Minas Gerais - 2022")
```
